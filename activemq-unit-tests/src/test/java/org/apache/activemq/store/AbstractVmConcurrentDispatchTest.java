...
argument_list|()
expr_stmt|;
comment|//run for 10 seconds as that seems to be enough time to cause an error
comment|//if there is going to be one
name|tasks
operator|.
...
argument_list|)
decl_stmt|;
comment|//If using topics, just test a generic topic name
comment|//If useTopic is false then we are testing virtual topics/queue consumes
name|Destination
name|destination
init|=
name|useTopic
