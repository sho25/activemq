...
specifier|private
name|boolean
name|addPropertiesOnFirstMsgOnly
init|=
literal|false
decl_stmt|;
...
argument_list|)
expr_stmt|;
comment|// Allows the options on the destination to configure the stream
if|if
condition|(
name|destination
operator|.
...
specifier|public
name|void
name|setAddPropertiesOnFirstMsgOnly
parameter_list|(
name|boolean
name|propertiesOnFirstMsgOnly
parameter_list|)
block|{
name|this
operator|.
