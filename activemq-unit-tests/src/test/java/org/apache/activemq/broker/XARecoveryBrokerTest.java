...
argument_list|)
expr_stmt|;
comment|// ensure subX can get it's copy of the messages
name|consumerInfoX
operator|=
name|createConsumerInfo
argument_list|(
...
name|assertNotNull
argument_list|(
literal|"unexpected null for subX on: "
operator|+
name|i
argument_list|,
name|m
...
argument_list|)
expr_stmt|;
comment|// verify still unavailable
name|message
operator|=
name|receiveMessage
argument_list|(
...
specifier|public
name|void
name|initCombosForTestNoDupOnRollbackRedelivery
parameter_list|()
block|{
name|addCombinationValues
argument_list|(
...
specifier|public
name|void
name|testNoDupOnRollbackRedelivery
parameter_list|()
throws|throws
name|Exception
block|{
...
name|info
argument_list|(
literal|"new connection/consumer for redelivery"
argument_list|)
expr_stmt|;
name|connection
operator|.
