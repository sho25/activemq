...
specifier|public
name|void
name|testInvalidClientIdAndDurableSubs
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
expr_stmt|;
comment|// ensure remoteConnection fails with InvalidClientId
name|ActiveMQConnectionFactory
...
argument_list|()
expr_stmt|;
comment|// setup some durable subs to have some local work to do
name|ActiveMQConnectionFactory
name|vmFactory
init|=
operator|new
