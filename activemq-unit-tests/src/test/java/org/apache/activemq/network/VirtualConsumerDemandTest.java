...
name|ActiveMQTopic
argument_list|(
literal|"VirtualTopic.include.test.bar2"
argument_list|)
argument_list|)
decl_stmt|;
name|MessageProducer
name|includedProducer3
init|=
name|localSession
operator|.
name|createProducer
...
name|ActiveMQTopic
argument_list|(
literal|"VirtualTopic.include.test.bar3"
argument_list|)
argument_list|)
decl_stmt|;
name|Thread
...
argument_list|()
decl_stmt|;
comment|//No queue destination on the remote side so should not forward
specifier|final
name|DestinationStatistics
name|destinationStatistics3
init|=
name|localBroker
operator|.
name|getDestination
...
name|ActiveMQQueue
argument_list|(
literal|"Consumer.cons1.VirtualTopic.include.test.bar2"
argument_list|)
argument_list|)
operator|.
name|getDestinationStatistics
...
argument_list|)
expr_stmt|;
comment|//should not have forwarded for 3rd topic
name|Thread
operator|.
name|sleep
argument_list|(
...
specifier|public
name|void
name|testDynamicFlowForceDurable
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testSecondNonIncludedCompositeTopicForwardSameQueue
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
comment|/**      * This tests that having 2 composite destinations (1 included for dynamic flow and 1 not)      * will allow messages to flow and that deleting 1 destination dosen't clear out the virtual      * consumer map except for what should be cleared.      *      */
annotation|@
name|Test
argument_list|(
name|timeout
...
specifier|public
name|void
name|testTwoCompositeTopicsRemove1
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|//verify there are 2 virtual destinations but only 1 consumer and broker dest
name|assertAdvisoryBrokerCounts
argument_list|(
literal|2
argument_list|,
...
argument_list|)
expr_stmt|;
comment|//verify there is is only 1 virtual dest after deletion
name|assertAdvisoryBrokerCounts
argument_list|(
literal|1
argument_list|,
...
argument_list|)
expr_stmt|;
comment|//make sure messages are still forwarded even after 1 composite topic was deleted
name|waitForDispatchFromLocalBroker
argument_list|(
name|destinationStatistics
argument_list|,
...
name|ActiveMQQueue
argument_list|(
literal|"exclude.test.bar.bridge"
argument_list|)
argument_list|)
decl_stmt|;
name|runtimeBroker
