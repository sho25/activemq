...
begin_comment
comment|/**  * Test the HTTPS Connector, where we configure the client truststore directly on the connection factory, as opposed to  * using system properties.  */
end_comment

begin_class
specifier|public
class|class
name|HttpsClientSettingsTest
extends|extends
name|JmsTopicSendReceiveTest
block|{
comment|/**      *       */
