...
name|assertEquals
argument_list|(
literal|"number of queues match"
argument_list|,
name|drainingBroker
operator|.
name|getAdminView
...
expr_stmt|;
block|}
comment|// add virtual topic consumer Q
name|MessageConsumer
name|messageConsumerA
init|=
name|session
operator|.
name|createConsumer
...
name|ActiveMQQueue
argument_list|(
literal|"Consumer.A.VirtualTopic.Y"
argument_list|)
argument_list|)
decl_stmt|;
name|MessageConsumer
name|messageConsumeB
init|=
name|session
operator|.
name|createConsumer
...
name|ActiveMQQueue
argument_list|(
literal|"Consumer.B.VirtualTopic.Y"
argument_list|)
argument_list|)
decl_stmt|;
name|producer
