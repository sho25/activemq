...
return|;
block|}
comment|/**      * All updated are are funneled through this method. The updates a converted      * to a JournalMessage which is logged to the journal and then the data from      * the JournalMessage is used to update the index just like it would be done      * durring a recovery process.      */
specifier|public
name|Location
name|store
parameter_list|(
...
condition|)
block|{
comment|// Find empty journal files to remove.
specifier|final
name|HashSet
argument_list|<
name|Integer
