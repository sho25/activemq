...
name|returnValue
argument_list|(
literal|"Microsoft_SQL_Server_2005_jdbc_driver"
argument_list|)
argument_list|)
expr_stmt|;
name|allowing
...
name|assertTrue
argument_list|(
literal|"has the locker override"
argument_list|,
name|adapter
operator|.
name|getLocker
...
specifier|public
name|void
name|testJdbcLockConfigDefault
parameter_list|()
throws|throws
name|Exception
block|{
...
name|assertEquals
argument_list|(
literal|"has the default locker"
argument_list|,
name|adapter
operator|.
name|getLocker
...
name|CONF_ROOT
operator|+
literal|"connector-properties.xml"
argument_list|)
argument_list|)
decl_stmt|;
name|broker
...
name|fail
argument_list|(
literal|"Should have got an exception"
argument_list|)
expr_stmt|;
block|}
try|try
...
name|fail
argument_list|(
literal|"Should have caught an exception"
argument_list|)
expr_stmt|;
block|}
catch|catch
