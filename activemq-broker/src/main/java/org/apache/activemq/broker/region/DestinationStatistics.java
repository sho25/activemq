...
literal|"forwards"
argument_list|,
literal|"The number of messages that have been forwarded to a networked broker from the destination"
argument_list|)
expr_stmt|;
name|inflight
operator|=
...
literal|"inflight"
argument_list|,
literal|"The number of messages dispatched but awaiting acknowledgement"
argument_list|)
expr_stmt|;
name|expired
operator|=
...
literal|"expired"
argument_list|,
literal|"The number of messages that have expired"
argument_list|)
expr_stmt|;
name|consumers
operator|=
...
name|CountStatisticImpl
argument_list|(
literal|"blockedSends"
argument_list|,
literal|"number of messages that have to wait for flow control"
argument_list|)
expr_stmt|;
name|blockedTime
operator|=
