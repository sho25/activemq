...
literal|false
decl_stmt|;
comment|/**      * This Map is used to keep track of messages that have been dispatched in sorted order to      * optimize message acknowledgement      */
specifier|private
name|NavigableMap
argument_list|<
name|MessageId
...
argument_list|)
expr_stmt|;
name|updateInflightMessageSizeOnAck
argument_list|(
name|ack
argument_list|)
expr_stmt|;
...
block|}
block|}
comment|/**      * Update the inflight statistics on message ack.  Since a message ack could be a range,      * we need to grab a subtree of the dispatched map to acknowledge messages.  Finding the      * subMap is an O(log n) operation.      * @param ack      */
specifier|private
name|void
name|updateInflightMessageSizeOnAck
parameter_list|(
