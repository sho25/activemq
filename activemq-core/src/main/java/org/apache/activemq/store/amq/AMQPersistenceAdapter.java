...
name|Scheduler
argument_list|(
literal|"AMQPersistenceAdapter Scheduler"
argument_list|)
expr_stmt|;
block|}
name|this
...
name|debug
argument_list|(
literal|"dataFilesInProgress.values: ("
operator|+
name|dataFilesInProgress
operator|.
name|values
...
name|error
argument_list|(
literal|"Failed to write command: "
operator|+
name|command
operator|+
literal|". Reason: "
...
parameter_list|)
block|{
comment|// reference store send has adequate duplicate suppression
return|return
operator|-
literal|1
return|;
