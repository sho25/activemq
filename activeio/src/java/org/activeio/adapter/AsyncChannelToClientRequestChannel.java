...
begin_comment
comment|/**  * Creates a {@see org.activeio.RequestChannel} out of a {@see org.activeio.SyncChannel}.  * Does not support handing requests.  It can only be used to send requests.    *   * @version $Revision$  */
end_comment
