...
begin_comment
comment|/**  * Connects a Slave Broker to a Master when using<a  * href="http://activemq.apache.org/masterslave.html">Master Slave</a> for High  * Availability of messages.  *   * @org.apache.xbean.XBean  *   */
end_comment
...
name|remoteBroker
operator|+
literal|" has been reestablished."
argument_list|)
expr_stmt|;
block|}
else|else
...
name|error
argument_list|(
literal|"MasterConnector failed to send BrokerInfo in transportResumed:"
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
name|error
argument_list|(
literal|"MasterConnector failed to restart localBroker in transportResumed:"
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
name|info
argument_list|(
literal|"Slave stopped before connected to the master."
argument_list|)
expr_stmt|;
block|}
