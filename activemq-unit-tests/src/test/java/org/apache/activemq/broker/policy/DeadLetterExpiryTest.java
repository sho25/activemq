...
argument_list|)
expr_stmt|;
comment|// allow duplicates through the cursor
name|pMap
operator|.
name|put
argument_list|(
...
name|assertTrue
argument_list|(
literal|"all messages expired even duplicates!"
argument_list|,
name|Wait
operator|.
name|waitFor
