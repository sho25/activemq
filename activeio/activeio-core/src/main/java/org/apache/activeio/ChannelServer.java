...
begin_comment
comment|/**  * A ChannelServer is used to accept incoming requests to establish new Channel sessions.  *   * Like a normal {@see org.apache.activeio.Channel}, A ChannelServer comes in two falvors, either:  * {@see org.apache.activeio.AsyncChannelServer} or   * {@see org.apache.activeio.SynchChannelServer}.  *   * @version $Revision$  */
end_comment
