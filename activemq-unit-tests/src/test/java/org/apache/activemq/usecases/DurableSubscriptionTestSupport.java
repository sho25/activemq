...
specifier|public
name|void
name|testDurableSubscriptionBrokerRestart
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// Make sure cleanup kicks in
name|Thread
operator|.
name|sleep
argument_list|(
...
argument_list|()
expr_stmt|;
comment|// connect second durable to pick up retroactive message
name|connection
operator|.
name|start
argument_list|()
...
specifier|public
name|void
name|testDurableSubscriptionRollbackRedeliver
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// Ensure that consumer will receive messages sent and rolled back
name|consumer
operator|=
name|session
operator|.
...
specifier|public
name|void
name|testIndividualAckWithDurableSubs
parameter_list|()
throws|throws
name|Exception
block|{
