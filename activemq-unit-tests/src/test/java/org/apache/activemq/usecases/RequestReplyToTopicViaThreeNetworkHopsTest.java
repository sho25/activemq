...
specifier|public
class|class
name|RequestReplyToTopicViaThreeNetworkHopsTest
block|{
specifier|protected
specifier|static
specifier|final
name|int
name|CONCURRENT_CLIENT_COUNT
init|=
literal|5
decl_stmt|;
specifier|protected
...
argument_list|)
expr_stmt|;
comment|// duplex is necessary to serialise sends with consumer/destination creation
name|edge1
operator|.
name|coreConnectTo
argument_list|(
...
argument_list|)
expr_stmt|;
name|sendWithRetryOnDeletedDest
argument_list|(
name|req_prod
argument_list|,
name|msg
...
expr_stmt|;
comment|//
comment|// Execute up to 20 clients at a time to simulate that load.
comment|//
name|clientExecPool
operator|=
operator|new
...
expr_stmt|;
comment|//
comment|// Run the tests on Temp Topics.
comment|//
name|LOG
operator|.
name|info
argument_list|(
literal|"** STARTING TEMP TOPIC TESTS"
argument_list|)
expr_stmt|;
name|iter
operator|=
...
name|info
argument_list|(
literal|"** FINISHED TEMP TOPIC TESTS AFTER "
operator|+
name|iter
operator|+
literal|" ITERATIONS, testError:"
operator|+
name|testError
operator|+
literal|", fatal: "
...
name|assertTrue
argument_list|(
literal|"test completed in time"
argument_list|,
name|allDoneOnTime
argument_list|)
expr_stmt|;
...
name|error
argument_list|(
literal|"error processing echo service requests"
argument_list|,
name|ex
argument_list|)
expr_stmt|;
...
block|}
block|}
comment|/**          * Process one request for the Echo Service.          */
specifier|protected
name|void
name|processRequest
parameter_list|(
...
name|debug
argument_list|(
literal|"SENDING ECHO RESPONSE to:"
operator|+
name|resp_dest
argument_list|)
expr_stmt|;
...
name|info
argument_list|(
literal|"Starting Topic Traffic Generator"
argument_list|)
expr_stmt|;
while|while
condition|(
...
expr_stmt|;
comment|//
comment|// Time out the receipt; early messages may not make it.
comment|//
name|msg
operator|=
name|cons
...
name|warn
argument_list|(
literal|"traffic generator failed on jms exception"
argument_list|,
name|jms_exc
argument_list|)
expr_stmt|;
...
name|info
argument_list|(
literal|"Shutdown of Topic Traffic Generator; send count = "
operator|+
name|send_count
argument_list|)
expr_stmt|;
...
name|warn
argument_list|(
literal|"failed to shutdown connection"
argument_list|,
name|jms_exc
argument_list|)
expr_stmt|;
