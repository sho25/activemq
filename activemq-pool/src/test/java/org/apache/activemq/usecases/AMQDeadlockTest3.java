...
specifier|public
name|void
name|testQueueLimitsWithOneBrokerSameConnection
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testQueueLimitsWithTwoBrokerProduceandConsumeonDifferentBrokersWithOneConnectionForProducing
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testQueueLimitsWithTwoBrokerProduceandConsumeonDifferentBrokersWithSeperateConnectionsForProducing
parameter_list|()
throws|throws
name|Exception
block|{
...
name|info
argument_list|(
literal|"Listener1 Consumed message "
operator|+
name|msg
operator|.
name|getIntProperty
...
name|info
argument_list|(
literal|"PooledProducer sent message: "
operator|+
name|count
operator|.
name|get
...
name|info
argument_list|(
literal|"Non-PooledProducer sent message: "
operator|+
name|count
operator|.
name|get
