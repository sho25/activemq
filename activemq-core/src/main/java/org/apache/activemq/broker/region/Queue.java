...
condition|)
block|{
comment|// This means all subs were full...
name|rc
operator|.
name|add
argument_list|(
...
block|}
block|}
comment|//LOG.info(getName()+" Pending messages:");
comment|//for (MessageReference n : rc) {
comment|//     LOG.info(getName()+"  - " + n.getMessageId());
comment|// }
return|return
name|rc
return|;
