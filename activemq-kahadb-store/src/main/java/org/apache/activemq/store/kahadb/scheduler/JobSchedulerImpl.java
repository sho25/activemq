...
argument_list|()
decl_stmt|;
comment|// Read the list of scheduled events and fire the jobs.  Once done with the batch
comment|// remove all that were fired, and reschedule as needed.
name|Map
operator|.
name|Entry
argument_list|<
...
block|{
comment|// cron job will have a repeat time.
if|if
condition|(
name|repeat
operator|==
