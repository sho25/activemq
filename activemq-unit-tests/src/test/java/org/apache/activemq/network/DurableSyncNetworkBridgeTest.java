...
specifier|protected
name|String
name|includeTopicName
init|=
literal|"include.test.bar"
decl_stmt|;
specifier|protected
name|String
name|includeTopicName2
init|=
...
argument_list|)
expr_stmt|;
name|assertNCSubscriptionsCount
argument_list|(
name|broker2
argument_list|,
name|topic
...
condition|)
block|{
comment|// brokerService.setPlugins(new BrokerPlugin[] {new
comment|// JavaRuntimeConfigurationPlugin()});
comment|// brokerService.setUseVirtualDestSubs(true);
comment|// brokerService.setUseVirtualDestSubsOnCreation(isUsevirtualDestinationSubscriptionsOnCreation);
name|Wait
operator|.
name|waitFor
argument_list|(
...
name|addConnector
argument_list|(
literal|"tcp://localhost:0?wireFormat.version="
operator|+
name|remoteBrokerWireFormatVersion
argument_list|)
expr_stmt|;
