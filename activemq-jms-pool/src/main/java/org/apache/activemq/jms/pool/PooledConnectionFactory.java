...
argument_list|)
expr_stmt|;
comment|// Set max wait time to control borrow from pool.
name|this
operator|.
name|connectionsPool
operator|.
...
condition|(
operator|!
literal|"Timeout waiting for idle object"
operator|.
name|equals
argument_list|(
name|ex
...
expr_stmt|;
block|}
comment|/**      * Gets the connection timeout value. The maximum time waited to get a Connection from the pool.      * The default value is 30 seconds.      *      * @return connection timeout value (milliseconds)      */
specifier|public
name|int
name|getConnectionTimeout
parameter_list|()
...
return|;
block|}
comment|/**      * Sets the connection timeout value for getting Connections from this pool in Milliseconds,      * defaults to 30 seconds.      *      * @param connectionTimeout      *      The maximum time to wait for getting a pooled Connection.      */
specifier|public
name|void
...
name|setProperty
argument_list|(
literal|"timeBetweenExpirationCheckMillis"
argument_list|,
name|Long
operator|.
name|toString
