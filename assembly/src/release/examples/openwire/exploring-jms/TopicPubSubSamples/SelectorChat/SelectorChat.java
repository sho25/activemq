...
argument_list|)
decl_stmt|;
comment|// NOTE: The subscriber's message selector will now be set:
name|javax
operator|.
name|jms
operator|.
...
literal|".\n"
operator|+
literal|"The application will publish messages with "
operator|+
name|PROPERTY_NAME
operator|+
literal|" set to "
...
literal|" topic .\n"
operator|+
literal|"The application also subscribes to that topic, selecting only messages where "
operator|+
name|PROPERTY_NAME
operator|+
literal|" is "
...
argument_list|)
expr_stmt|;
comment|// NOTE: here we set a property on messages to be published:
name|msg
operator|.
...
name|println
argument_list|(
literal|"error: missing selection"
argument_list|)
expr_stmt|;
name|System
operator|.
...
name|println
argument_list|(
literal|"error: selection must be supplied"
argument_list|)
expr_stmt|;
name|printUsage
argument_list|()
...
name|append
argument_list|(
literal|"usage: java SelectorChat (options) ...\n\n"
argument_list|)
expr_stmt|;
name|use
operator|.
...
name|append
argument_list|(
literal|"  -s selection  Message selector value. (Required)\n"
argument_list|)
expr_stmt|;
name|use
operator|.
