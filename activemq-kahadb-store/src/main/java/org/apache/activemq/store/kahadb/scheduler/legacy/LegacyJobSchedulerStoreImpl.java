...
begin_comment
comment|/**  * Read-only view of a legacy JobSchedulerStore implementation.  */
end_comment
...
block|}
block|}
comment|/**      * Returns the named Job Scheduler if it exists, otherwise throws an exception.      *      * @param name      *     The name of the scheduler that is to be returned.      *      * @return the named scheduler if it exists.      *      * @throws Exception if the named scheduler does not exist in this store.      */
specifier|public
name|LegacyJobSchedulerImpl
...
name|NoSuchElementException
argument_list|(
literal|"No such Job Scheduler in this store: "
operator|+
name|name
argument_list|)
throw|;
...
return|;
block|}
comment|/**      * Returns the names of all the schedulers that exist in this scheduler store.      *      * @return a set of names of all scheduler instances in this store.      *      * @throws Exception if an error occurs while collecting the scheduler names.      */
specifier|public
name|Set
argument_list|<
name|String
...
block|{
return|return
literal|"LegacyJobSchedulerStore:"
operator|+
name|this
operator|.
name|directory
