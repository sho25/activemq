...
specifier|public
class|class
name|DurableSubProcessWithRestartTest
block|{
specifier|private
specifier|static
specifier|final
...
argument_list|()
decl_stmt|;
comment|// this is a nice test but it takes 5mins, may be handy in the future
comment|// resulting bug https://issues.apache.org/jira/browse/AMQ-3190
annotation|@
name|Ignore
argument_list|(
literal|"covered by org.apache.activemq.usecases.DurableSubscriptionOfflineTest.testNoMissOnMatchingSubAfterRestart()"
argument_list|)
annotation|@
name|Test
specifier|public
