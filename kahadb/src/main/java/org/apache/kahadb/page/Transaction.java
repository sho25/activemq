...
argument_list|()
decl_stmt|;
comment|// TODO: if a large update transaction is in progress, we may want to move
comment|// all the current updates to a temp file so that we don't keep using
comment|// up memory.
name|writes
operator|.
name|put
