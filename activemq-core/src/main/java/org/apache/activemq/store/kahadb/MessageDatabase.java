...
condition|)
block|{
comment|// store negative sequence to indicate that it was unmatched
name|ackSequenceToStore
operator|=
operator|new
name|Long
...
condition|)
block|{
comment|// unmatched, need to add ack locations for the intermediate sequences
for|for
control|(
name|long
name|matchedGapSequence
init|=
name|extractSequenceId
argument_list|(
name|prev
...
condition|)
block|{
comment|// on upgrade need to fill ackLocation
for|for
control|(
name|Iterator
argument_list|<
