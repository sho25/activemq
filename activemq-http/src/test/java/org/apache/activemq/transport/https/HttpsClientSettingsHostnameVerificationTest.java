...
begin_comment
comment|/**  * Here we are using a TLS cert which does not have "localhost" as the CN. We expect hostname verification to fail by default.  */
end_comment

begin_class
specifier|public
class|class
name|HttpsClientSettingsHostnameVerificationTest
extends|extends
name|JmsTopicSendReceiveTest
block|{
comment|/**      *       */
...
name|fail
argument_list|(
literal|"Failure expected on hostname verification"
argument_list|)
expr_stmt|;
block|}
catch|catch
