...
begin_comment
comment|/*  * pause producers if consumers stall and verify broker drained before resume  */
end_comment
...
specifier|public
class|class
name|AMQ5266StarvedConsumerTest
block|{
specifier|static
name|Logger
name|LOG
...
name|name
operator|=
literal|"#{0},producerThreads:{1},consumerThreads:{2},mL:{3},useCache:{4},useDefaultStore:{5},optimizedDispatch:{6}"
argument_list|)
specifier|public
specifier|static
name|Iterable
...
parameter_list|()
block|{
comment|// wait for queue size to go to zero
try|try
block|{
while|while
condition|(
...
name|activemqQueues
init|=
literal|"activemq,activemq2,activemq3,activemq4"
decl_stmt|;
comment|//,activemq5,activemq6,activemq7,activemq8,activemq9";
name|int
