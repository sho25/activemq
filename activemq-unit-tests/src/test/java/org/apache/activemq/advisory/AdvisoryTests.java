...
name|name
operator|=
literal|"includeBodyForAdvisory={0}"
argument_list|)
specifier|public
specifier|static
name|Collection
...
specifier|public
name|void
name|testMessageDeliveryVTAdvisory
parameter_list|()
throws|throws
name|Exception
block|{
...
name|ActiveMQQueue
argument_list|(
literal|"Consumer.B.VirtualTopic.TEST"
argument_list|)
decl_stmt|;
name|MessageConsumer
name|consumerB
...
argument_list|)
decl_stmt|;
comment|// throw messages at the vt
name|MessageProducer
name|producer
init|=
name|s
