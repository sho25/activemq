...
expr_stmt|;
block|}
comment|/**      * Create a new receiver instance.      *      * @param session      * 		  The parent session that created the receiver.      * @param address      *        The address that this receiver should listen on.      * @param receiverId      *        The unique ID assigned to this receiver.      * @param senderMode      *        The {@link SenderSettleMode} to use on open.      * @param receiverMode      *        The {@link ReceiverSettleMode} to use on open.      */
specifier|public
name|AmqpReceiver
parameter_list|(
name|AmqpSession
...
expr_stmt|;
block|}
comment|/**      * Reject a message that was dispatched under the given Delivery instance.      *      * @param delivery      *        the Delivery instance to reject.      *      * @throws IOException if an error occurs while sending the release.      */
specifier|public
name|void
name|reject
parameter_list|(
