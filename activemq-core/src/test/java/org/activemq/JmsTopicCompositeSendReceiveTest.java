...
specifier|public
class|class
name|JmsTopicCompositeSendReceiveTest
extends|extends
name|JmsTopicSendReceiveTest
block|{
specifier|private
...
block|}
block|}
comment|/**      * Returns the consumer subject.      *      * @return String - consumer subject      * @see org.activemq.test.TestSupport#getConsumerSubject()      */
specifier|protected
name|String
...
return|;
block|}
comment|/**      * Returns the producer subject.      *      * @return String - producer subject      * @see org.activemq.test.TestSupport#getProducerSubject()      */
specifier|protected
name|String
