...
specifier|public
name|void
name|testReceiveAfterConnectionClose
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
expr_stmt|;
comment|// this will force a rollback on the TX (It should at least)
name|connection
operator|.
name|close
argument_list|()
...
specifier|public
name|void
name|testAcceptedButNotSettledInTXRemainsAquiredCanBeAccepted
parameter_list|()
throws|throws
name|Exception
block|{
name|doTestAcceptedButNotSettledInTXRemainsAquired
argument_list|(
name|Accepted
operator|.
name|getInstance
...
specifier|public
name|void
name|testAcceptedButNotSettledInTXRemainsAquiredCanBeReleased
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testAcceptedButNotSettledInTXRemainsAquiredCanBeRejected
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testAcceptedButNotSettledInTXRemainsAquiredCanBeModifiedAsFailed
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testAcceptedButNotSettledInTXRemainsAquiredCanBeModifiedAsUndeliverable
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
expr_stmt|;
comment|// Message should remain acquired an not be redelivered.
name|assertEquals
argument_list|(
literal|1
argument_list|,
...
condition|)
block|{
comment|// Receiver should be able to release the still acquired message and the
comment|// broker should redispatch it to the client again.
name|received
operator|.
name|release
argument_list|()
...
condition|)
block|{
comment|// Receiver should be able to accept the still acquired message and the
comment|// broker should then mark it as consumed.
name|received
operator|.
name|accept
argument_list|()
...
condition|)
block|{
comment|// Depending on the undeliverable here state the message will either be
comment|// redelivered or DLQ'd
name|Modified
name|modified
init|=
operator|(
...
specifier|public
name|void
name|testTransactionallyAcquiredMessageCanBeTransactionallyConsumed
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// Consume under TX but settle this time
name|session
operator|.
name|begin
argument_list|()
...
argument_list|()
expr_stmt|;
comment|// Should still be acquired
name|assertEquals
argument_list|(
literal|1
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// Consume under TX and settle but rollback, message should be redelivered.
name|session
operator|.
name|begin
argument_list|()
...
argument_list|)
expr_stmt|;
comment|// Consume under TX and commit it this time.
name|session
operator|.
name|begin
argument_list|()
...
argument_list|()
expr_stmt|;
comment|// Check that it is now consumed and no more message available
name|assertTrue
argument_list|(
name|received
operator|.
...
specifier|public
name|void
name|testReceiversCommitAndRollbackWithMultipleSessionsInSingleTXNoSettlement
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
expr_stmt|;
comment|// After rollback message should still be acquired so we read last sent message.
block|{
name|AmqpMessage
name|message
init|=
...
expr_stmt|;
block|}
comment|// We should have now drained the Queue
name|AmqpMessage
name|message
init|=
name|receiver
...
specifier|public
name|void
name|testCommitAndRollbackWithMultipleSessionsInSingleTXNoSettlement
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
expr_stmt|;
comment|// Should be ten message available for dispatch given that we sent and committed one, and
comment|// releases another we had previously received.
name|receiver
operator|.
name|flow
argument_list|(
...
name|assertNotNull
argument_list|(
literal|"Expected a message for: "
operator|+
name|i
argument_list|,
name|message
