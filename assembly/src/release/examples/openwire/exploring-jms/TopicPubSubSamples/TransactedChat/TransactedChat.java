...
argument_list|)
expr_stmt|;
comment|// We want to be able up commit/rollback messages published,
comment|// but not affect messages consumed. Therefore, we need two sessions.
name|publishSession
operator|=
name|connect
operator|.
...
argument_list|)
expr_stmt|;
comment|// Now start the Connection
name|connect
operator|.
name|start
argument_list|()
...
name|println
argument_list|(
literal|"TransactedChat application:"
argument_list|)
expr_stmt|;
name|System
operator|.
...
name|println
argument_list|(
literal|"The application will stage messages to the "
operator|+
name|APP_TOPIC
operator|+
literal|" topic until you either commit them or roll them back."
argument_list|)
expr_stmt|;
name|System
operator|.
...
name|println
argument_list|(
literal|"The application also subscribes to that topic to consume any committed messages published there.\n"
argument_list|)
expr_stmt|;
name|System
operator|.
...
name|println
argument_list|(
literal|"1. Enter text to publish and then press Enter to stage the message."
argument_list|)
expr_stmt|;
name|System
operator|.
...
name|println
argument_list|(
literal|"2. Add a few messages to the transaction batch."
argument_list|)
expr_stmt|;
name|System
operator|.
...
name|println
argument_list|(
literal|"     o Enter the text 'COMMIT', and press Enter to publish all the staged messages."
argument_list|)
expr_stmt|;
name|System
operator|.
...
name|println
argument_list|(
literal|"     o Enter the text 'CANCEL', and press Enter to drop the staged messages waiting to be sent."
argument_list|)
expr_stmt|;
name|showMessage
operator|=
...
condition|)
block|{
comment|// Rollback the messages. A new transaction is implicitly
comment|// started for following messages.
name|System
operator|.
name|out
operator|.
...
name|println
argument_list|(
literal|"Staged messages have been cleared."
argument_list|)
expr_stmt|;
name|showMessage
operator|=
literal|false
expr_stmt|;
comment|// don't show the help message again.
block|}
elseif|else
if|if
condition|(
...
literal|0
condition|)
comment|// See if we should send the messages
if|if
condition|(
name|s
operator|.
...
condition|)
block|{
comment|// Commit (send) the messages. A new transaction is
comment|// implicitly  started for following messages.
name|System
operator|.
name|out
operator|.
...
name|println
argument_list|(
literal|"Staged messages have all been sent."
argument_list|)
expr_stmt|;
name|showMessage
operator|=
literal|false
expr_stmt|;
comment|// dont't show the help message again.
block|}
else|else
block|{
name|javax
...
argument_list|)
expr_stmt|;
comment|// Publish the message persistently
name|publisher
operator|.
name|send
argument_list|(
...
argument_list|()
expr_stmt|;
comment|// Rollback any uncommitted messages.
name|connect
operator|.
name|close
argument_list|()
...
name|append
argument_list|(
literal|"usage: java TransactedChat (options) ...\n\n"
argument_list|)
expr_stmt|;
name|use
operator|.
