...
comment|//        // write to it.
comment|//        if (!dataFiles.isEmpty()) {
comment|//
comment|//            // See if the lastSyncedLocation is valid..
comment|//            Location l = lastAppendLocation.get();
comment|//            if (l != null&& l.getDataFileId() != dataFiles.getTail().getDataFileId().intValue()) {
comment|//                l = null;
comment|//            }
comment|//
...
comment|//            // of checking
comment|//            try {
comment|//                l = recoveryCheck(dataFiles.getTail(), l);
comment|//                lastAppendLocation.set(l);
comment|//            } catch (IOException e) {
comment|//                LOG.warn("recovery check failed", e);
comment|//            }
comment|//        }
block|}
specifier|public
