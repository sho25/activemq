...
decl_stmt|;
comment|/**      * Specifies whether the broker is embedded      */
specifier|public
specifier|final
specifier|static
name|String
...
return|;
block|}
comment|// compare load balancing flag
name|String
name|tmpEmbeddedBroker
init|=
operator|(
name|String
operator|)
