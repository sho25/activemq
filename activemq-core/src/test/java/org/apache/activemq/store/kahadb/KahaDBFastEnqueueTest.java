...
argument_list|()
decl_stmt|;
comment|//System.out.println("Pre shutdown: Index totalWritten:       " + kahaDBPersistenceAdapter.getStore().getPageFile().totalWritten);
name|double
name|duration
init|=
name|System
...
argument_list|)
expr_stmt|;
comment|//System.out.println("Total index write:   " + kahaDBPersistenceAdapter.getStore().getPageFile().totalWritten);
name|System
operator|.
name|out
operator|.
