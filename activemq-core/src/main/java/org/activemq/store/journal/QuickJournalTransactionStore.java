...
expr_stmt|;
block|}
comment|/**      * @throws IOException      * @see org.activemq.store.TransactionStore#prepare(TransactionId)      */
specifier|public
name|void
name|prepare
parameter_list|(
...
block|}
block|}
comment|/**      * @throws IOException      * @see org.activemq.store.TransactionStore#rollback(TransactionId)      */
specifier|public
name|void
name|rollback
parameter_list|(
