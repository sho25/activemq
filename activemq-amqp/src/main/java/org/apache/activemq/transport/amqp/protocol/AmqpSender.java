...
block|{
comment|// reset delivery counter - dispatch from broker concurrent with credit=0 flow can go negative
name|logicalDeliveryCount
operator|=
literal|0
expr_stmt|;
...
argument_list|()
expr_stmt|;
comment|// force dispatch of matched/pending for topics (pending messages accumulate in the sub and are dispatched on update of prefetch)
name|subscription
operator|.
