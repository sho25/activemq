...
argument_list|)
expr_stmt|;
comment|// set up performance samplers indicated by the user
name|List
argument_list|<
name|PerformanceSampler
argument_list|>
...
expr_stmt|;
block|}
comment|// start the samplers
specifier|final
name|CountDownLatch
name|samplerCompletionLatch
init|=
operator|new
name|CountDownLatch
argument_list|(
...
try|try
block|{
comment|// wait for the clients to finish
name|clientCompletionLatch
operator|.
name|await
argument_list|()
...
block|{
comment|// if count-based, ramp-down time is not relevant, shut the samplers down
if|if
condition|(
name|getClientRunBasis
argument_list|()
...
name|debug
argument_list|(
literal|"Waiting for samplers to shut down"
argument_list|)
expr_stmt|;
name|samplerCompletionLatch
operator|.
...
name|debug
argument_list|(
literal|"All samplers completed"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|clientIndex
expr_stmt|;
comment|// If there are more clients than destinations, share
comment|// destinations per client
block|}
else|else
block|{
name|clientDestCount
