...
specifier|public
name|void
name|testReceiverCloseSendsRemoteClose
parameter_list|()
throws|throws
name|Exception
block|{
...
name|assertTrue
argument_list|(
literal|"Did not process remote close as expected"
argument_list|,
name|closed
operator|.
name|get
...
specifier|public
name|void
name|testPresettledReceiverReadsAllMessages
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testPresettledReceiverReadsAllMessagesInNonFlowBatchQueue
parameter_list|()
throws|throws
name|Exception
block|{
name|doTestPresettledReceiverReadsAllMessagesInNonFlowBatch
argument_list|(
literal|false
argument_list|)
expr_stmt|;
...
specifier|public
name|void
name|testPresettledReceiverReadsAllMessagesInNonFlowBatchTopic
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// consume less that flow
for|for
control|(
name|int
name|j
...
expr_stmt|;
block|}
comment|// flow more and consume all
name|receiver
operator|.
name|flow
argument_list|(
