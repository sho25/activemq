...
specifier|public
name|void
name|testDestinationGcAnonymousProducer
parameter_list|()
throws|throws
name|Exception
block|{
...
name|ActiveMQQueue
argument_list|(
literal|"Q.TEST.ANONYMOUS.PRODUCER"
argument_list|)
decl_stmt|;
name|brokerService
operator|.
...
argument_list|)
decl_stmt|;
comment|// wait for the queue to be marked for GC
name|logger
operator|.
name|info
argument_list|(
literal|"Waiting for '{}' to be marked for GC..."
argument_list|,
name|q
argument_list|)
expr_stmt|;
...
argument_list|)
expr_stmt|;
comment|// create anonymous producer and send a message
name|logger
operator|.
name|info
argument_list|(
literal|"Sending PERSISTENT message to QUEUE '{}'"
argument_list|,
name|q
operator|.
name|getPhysicalName
