...
expr_stmt|;
block|}
comment|/** 	 * Creates a new VelocityContext that is pre-populated with the JVMs 	 * system properties.  	 *  	 * @return - the VelocityContext that got created. 	 */
specifier|protected
name|VelocityContext
name|createVelocityContext
parameter_list|()
block|{
name|VelocityContext
name|ctx
