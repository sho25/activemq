...
expr_stmt|;
block|}
comment|/*      * revisit: This can be destination agnostic and back in the jdbc persistence adapter start      */
specifier|public
name|void
name|initAudit
parameter_list|()
...
name|error
argument_list|(
literal|"Failed to reload store message audit for queue store "
operator|+
name|destination
argument_list|)
expr_stmt|;
