...
expr_stmt|;
block|}
comment|//        LOG.info("After Load index file: " + store.pageFile.getFile().length());
comment|//        LOG.info("After remove index file: " + store.pageFile.getFile().length());
block|}
annotation|@
name|Test
specifier|public
...
name|Ignore
argument_list|(
literal|"Takes too long.. might have broken it."
argument_list|)
annotation|@
name|Test
specifier|public
...
argument_list|)
expr_stmt|;
comment|//        LOG.info("Num dataFiles:" + store.getJournal().getFiles().size());
block|}
specifier|abstract
specifier|protected
name|PListStore
