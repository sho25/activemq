...
begin_comment
comment|/**  Non transactional concurrent producer/consumer to single dest  */
end_comment
...
name|setProperty
argument_list|(
literal|"derby.system.durability"
argument_list|,
literal|"test"
argument_list|)
expr_stmt|;
...
expr_stmt|;
comment|// ensure all messages are queue or dlq messages
block|}
annotation|@
name|After
specifier|public
...
expr_stmt|;
block|}
comment|// verify empty dlq
name|assertEquals
argument_list|(
literal|"No pending messages"
argument_list|,
literal|0l
argument_list|,
operator|(
