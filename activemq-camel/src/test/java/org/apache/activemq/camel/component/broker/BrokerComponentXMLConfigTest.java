...
specifier|final
name|String
name|ROUTE_QUEUE_NAME
init|=
literal|"test.broker.component.route"
decl_stmt|;
specifier|protected
specifier|static
specifier|final
name|String
name|DIVERTED_QUEUE_NAME
init|=
literal|"test.broker.component.ProcessLater"
decl_stmt|;
specifier|protected
specifier|static
specifier|final
...
specifier|public
name|void
name|testRouteWithDestinationLimit
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testPreserveOriginalHeaders
parameter_list|()
throws|throws
name|Exception
block|{
