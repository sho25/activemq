...
argument_list|)
expr_stmt|;
comment|// One delivery for topic  ACCOUNT_PREFIX + "#"
name|String
name|result
init|=
name|listener
...
argument_list|)
expr_stmt|;
comment|// One delivery for topic  ACCOUNT_PREFIX + "a/1/2"
name|result
operator|=
name|listener
operator|.
...
argument_list|)
expr_stmt|;
comment|// One delivery for topic  ACCOUNT_PREFIX + "1/2/3"
name|result
operator|=
name|listener
operator|.
...
argument_list|)
expr_stmt|;
comment|// One message from topic subscription on ACCOUNT_PREFIX + "#"
name|result
operator|=
name|listener
operator|.
...
argument_list|)
expr_stmt|;
comment|// One message from topic subscription on ACCOUNT_PREFIX + "1/2/3"
name|result
operator|=
name|listener
operator|.
