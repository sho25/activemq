...
literal|".\n"
operator|+
literal|"The application will send messages to the "
operator|+
name|sQueue
operator|+
literal|" queue.\n"
...
name|rQueue
operator|+
literal|" queue to consume any messages allocated to it.\n\n"
operator|+
literal|"Type some text, and then press Enter to send it as a TextMesssage from "
operator|+
name|username
operator|+
literal|".\n"
...
comment|// Otherwise report that invalid message arrived.
if|if
condition|(
name|aMessage
operator|instanceof
...
name|println
argument_list|(
literal|"Warning: A message was discarded because it could not be processed "
operator|+
literal|"as a javax.jms.TextMessage."
argument_list|)
expr_stmt|;
block|}
block|}
...
name|append
argument_list|(
literal|"usage: java Talk (options) ...\n\n"
argument_list|)
expr_stmt|;
name|use
operator|.
