...
return|;
block|}
comment|/**      * Sets the upload strategy for BLOBs which are sent out-of-band by uploading them      * to some remote repository or the broker      */
specifier|public
name|void
name|setBlobUploadStrategy
parameter_list|(
name|BlobUploadStrategy
name|blobUploadStrategy
parameter_list|)
