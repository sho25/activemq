...
argument_list|)
expr_stmt|;
comment|// TODO use a DataInput implementation that talks direct to the
comment|// ByteBuffer
name|DataInputStream
name|dataIn
init|=
...
argument_list|)
decl_stmt|;
comment|// Command command = (Command) wireFormat.doUnmarshal(dataIn);
name|header
operator|.
name|setCommand
argument_list|(
