...
name|createBroker
argument_list|(
literal|"org/activemq/config/example.xml"
argument_list|)
expr_stmt|;
name|System
operator|.
...
name|assertTrue
argument_list|(
literal|"Should have a default persistence factory"
argument_list|,
name|factory
operator|instanceof
name|DefaultPersistenceAdapterFactory
...
name|assertEquals
argument_list|(
literal|"PersistenceFactory Config Error (journalLogFileSize)"
argument_list|,
literal|32768
argument_list|,
operator|(
...
name|assertEquals
argument_list|(
literal|"PersistenceFactory Config Error (journalLogFiles)"
argument_list|,
literal|4
argument_list|,
operator|(
...
name|assertEquals
argument_list|(
literal|"PersistenceFactory Config Error (useJournal)"
argument_list|,
literal|true
argument_list|,
operator|(
...
name|assertEquals
argument_list|(
literal|"PersistenceFactory Config Error (dataDirectory)"
argument_list|,
name|journalFile
operator|.
...
argument_list|)
expr_stmt|;
comment|// Check journal configurations
name|System
operator|.
name|out
operator|.
name|print
argument_list|(
literal|"Checking if persistence adapter was succesfully created... "
argument_list|)
expr_stmt|;
name|assertTrue
argument_list|(
...
name|DERBY_ROOT
operator|+
literal|"testJournalConfig/derbydb"
argument_list|)
decl_stmt|;
name|recursiveDelete
argument_list|(
...
name|JOURNAL_ROOT
operator|+
literal|"testJournaledJDBCConfig"
argument_list|)
decl_stmt|;
name|recursiveDelete
argument_list|(
...
name|createBroker
argument_list|(
literal|"org/activemq/config/config.xml"
argument_list|)
expr_stmt|;
try|try
block|{
