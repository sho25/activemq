...
specifier|public
name|void
name|testConsumerEventsOnTemporaryDestination
parameter_list|()
throws|throws
name|Exception
block|{
...
name|event
init|=
name|waitForProducerEvent
argument_list|()
decl_stmt|;
name|assertEquals
argument_list|(
literal|"Producer count"
argument_list|,
name|count
argument_list|,
name|event
