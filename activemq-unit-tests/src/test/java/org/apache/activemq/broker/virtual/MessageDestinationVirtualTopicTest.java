...
argument_list|)
expr_stmt|;
comment|// Create listener on Broker B1 for VT T2 witout setOriginalDest
name|Queue
name|consumer3Queue
init|=
name|session1
...
name|createQueue
argument_list|(
literal|"Consumer.A.VirtualTopic.T2"
argument_list|)
decl_stmt|;
comment|// Bind listener on queue for consumer D
name|MessageConsumer
...
name|createTopic
argument_list|(
literal|"VirtualTopic.T1,VirtualTopic.T2"
argument_list|)
decl_stmt|;
name|producer
operator|=
