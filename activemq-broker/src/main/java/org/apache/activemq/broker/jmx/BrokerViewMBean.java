...
parameter_list|()
function_decl|;
comment|/**      * Queue Query API, take a look at {@link DestinationsViewFilter} for more information      */
annotation|@
name|MBeanInfo
argument_list|(
literal|"Query queues"
argument_list|)
name|String
name|queryQueues
parameter_list|(
...
name|IOException
function_decl|;
comment|/**      * Topic Query API, take a look at {@link DestinationsViewFilter} for more information      */
annotation|@
name|MBeanInfo
argument_list|(
literal|"Query topics"
argument_list|)
name|String
name|queryTopics
parameter_list|(
