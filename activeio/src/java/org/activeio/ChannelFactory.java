...
begin_comment
comment|/**  * A {@see ChannelFactory}uses the requested URI's scheme to determine the  * actual {@see org.activeio.SynchChannelFactory}or  * {@see org.activeio.AsyncChannelFactory}implementation to use to create it's  * {@see org.activeio.Channel}s and {@see org.activeio.ChannelServer}s.  *   * Each URI scheme that {@see ChannelFactory}object handles will have a  * properties file located at: "META-INF/org.activeio.ChannelFactory/{scheme}".  *   */
end_comment
...
name|FactoryFinder
argument_list|(
literal|"META-INF/org.activeio.ChannelFactory/"
argument_list|)
decl_stmt|;
specifier|public
name|SyncChannel
