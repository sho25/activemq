...
expr_stmt|;
block|}
comment|//This test is slightly different in that it doesn't set bit 1 to
comment|//true as above which was causing a different result before AMQ-6431
annotation|@
name|Test
specifier|public
name|void
name|testLargeNumber2
parameter_list|()
block|{
name|BitArrayBin
name|toTest
