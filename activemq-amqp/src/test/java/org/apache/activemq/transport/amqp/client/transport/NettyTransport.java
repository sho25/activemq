...
expr_stmt|;
block|}
comment|/**      * Called when the transport connection failed and an error should be returned.      *      * @param cause      *      An IOException that describes the cause of the failed connection.      */
specifier|protected
name|void
name|connectionFailed
parameter_list|(
