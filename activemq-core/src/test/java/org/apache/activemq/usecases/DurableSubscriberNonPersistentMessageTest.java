...
argument_list|)
expr_stmt|;
comment|// Fuse and Apache 5.6 use different object strings if the consumer
comment|// is offline, maybe this has something to do with the difference in
comment|// behavior?
name|String
name|jmxObject
init|=
literal|"org.apache.activemq:BrokerName=localhost,Type=Subscription,active=false,name=Jason_MyDurableTopic"
decl_stmt|;
if|if
condition|(
name|brokerVersion
