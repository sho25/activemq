...
argument_list|)
expr_stmt|;
comment|//nc1.addExcludedDestination(ActiveMQDestination.createDestination("Consumer.*.global.>", ActiveMQDestination.QUEUE_TYPE));
name|nc1
operator|.
...
argument_list|)
expr_stmt|;
comment|//nc2.addExcludedDestination(ActiveMQDestination.createDestination("Consumer.*.global.>", ActiveMQDestination.QUEUE_TYPE));
name|nc2
operator|.
name|addDynamicallyIncludedDestination
argument_list|(
