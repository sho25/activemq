...
expr_stmt|;
block|}
comment|// copy next/currentNode into head
name|headNode
operator|.
name|setEntries
argument_list|(
...
try|try
block|{
comment|// keeping splitting till we get down to a single entry
comment|// then we need to overflow the value
name|getContainingList
argument_list|()
operator|.
name|storeNode
