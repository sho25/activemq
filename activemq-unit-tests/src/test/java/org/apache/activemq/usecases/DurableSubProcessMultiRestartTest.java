...
specifier|public
class|class
name|DurableSubProcessMultiRestartTest
block|{
specifier|private
specifier|static
specifier|final
...
try|try
block|{
comment|// register the subscription& start messages
name|durableSubscriber
operator|.
name|start
argument_list|()
...
expr_stmt|;
block|}
comment|// restart broker one last time
name|restartBroker
argument_list|()
expr_stmt|;
name|assertTrue
...
block|}
block|}
comment|/**      * Consumes massages from a durable subscription. Goes online/offline      * periodically.      */
specifier|private
specifier|final
class|class
name|DurableSubscriber
...
argument_list|()
operator|+
literal|" failed with JMSException"
argument_list|,
name|maybe
argument_list|)
expr_stmt|;
...
block|{
return|return
literal|"DurableSubProcessMultiRestartTest"
return|;
block|}
specifier|private
specifier|static
