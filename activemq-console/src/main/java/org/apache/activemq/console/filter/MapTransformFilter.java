...
argument_list|)
expr_stmt|;
comment|// Just set the toString of the message as the body of the stream
comment|// message
name|props
operator|.
name|setProperty
...
return|;
block|}
comment|/**      * Transform an openMBean composite data to a Map      *       * @param data - composite data to transform      * @return map object      */
specifier|protected
name|Map
name|transformToMap
parameter_list|(
...
condition|)
block|{
comment|// Unrecognized composite data. Throw exception.
block|}
else|else
block|{
throw|throw
...
argument_list|(
literal|"Unrecognized composite data to transform. composite type: "
operator|+
name|typeName
argument_list|)
throw|;
block|}
comment|// Process the JMS message header values
name|props
operator|.
name|setProperty
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Process the JMS custom message properties
name|props
operator|.
name|setProperty
argument_list|(
...
block|{
comment|// for primitives, we can't use Arrays.toString(), so we have to roll something similar.
name|int
name|len
init|=
name|Array
