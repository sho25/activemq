...
name|createBroker
argument_list|(
literal|"org/activemq/config/activemq.xml"
argument_list|)
expr_stmt|;
name|System
operator|.
...
name|fail
argument_list|(
literal|"Exception Starting Broker: "
operator|+
name|e
operator|.
name|toString
