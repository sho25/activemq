...
name|trace
argument_list|(
literal|"Flow: currentCredit={}, draining={}, drain={} credit={}, remoteCredit={}, queued={}"
argument_list|,
name|currentCredit
argument_list|,
name|draining
...
name|trace
argument_list|(
literal|"Flow: Pull case -> consumer control with prefetch (0)"
argument_list|)
expr_stmt|;
name|sendToActiveMQ
argument_list|(
...
name|trace
argument_list|(
literal|"Flow: update -> consumer control with prefetch (0)"
argument_list|)
expr_stmt|;
name|sendToActiveMQ
argument_list|(
...
name|trace
argument_list|(
literal|"Flow: no credit change -> no broker updates needed"
argument_list|)
expr_stmt|;
block|}
block|}
...
name|trace
argument_list|(
literal|"Sender:[{}] msgId={} currentCredit={}, draining={}, drain={} credit={}, remoteCredit={}, queued={}"
argument_list|,
name|getEndpoint
argument_list|()
operator|.
