...
expr_stmt|;
block|}
comment|// check retained messages
for|for
control|(
name|int
name|i
...
condition|)
block|{
comment|// skip this topic if subscribe failed
continue|continue;
block|}
specifier|final
name|Topic
...
argument_list|)
expr_stmt|;
comment|// set QoS of retained message to maximum of subscription QoS
name|retainedCopy
operator|.
name|qos
argument_list|(
...
name|warn
argument_list|(
literal|"Couldn't send retained message "
operator|+
name|msg
argument_list|,
name|e
...
block|{
comment|// duplicate SUBSCRIBE packet, nothing to do
return|return
operator|(
name|byte
operator|)
