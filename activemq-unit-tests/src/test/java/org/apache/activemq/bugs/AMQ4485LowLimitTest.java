...
block|}
block|}
comment|// used to explore contention with concurrentStoreandDispatch - sync commit and task queue reversing
comment|// order of cursor add and sequence assignment
specifier|public
name|void
name|x_testInterleavedSend
parameter_list|()
throws|throws
name|Exception
block|{
...
control|)
block|{
comment|//if (objectName.toString().contains(destination.getQualifiedName())) {
name|QueueViewMBean
name|qViewMBean
init|=
operator|(
