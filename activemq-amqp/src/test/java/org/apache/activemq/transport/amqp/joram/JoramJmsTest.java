...
condition|)
block|{
comment|// Fails due to durable subs not being implemented.
name|suite
operator|.
name|addTestSuite
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Fails due to https://issues.apache.org/jira/browse/PROTON-110 and DestinationImpl vs QueueImpl mapping issues
name|suite
operator|.
name|addTestSuite
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Fails due to inconsistent Message mapping in the JMS client.
name|suite
operator|.
name|addTestSuite
argument_list|(
