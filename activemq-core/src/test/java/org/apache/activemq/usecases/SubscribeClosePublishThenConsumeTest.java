...
literal|null
expr_stmt|;
comment|// Create the new connection before closing to avoid the broker shutting
comment|// down.
comment|// now create a new Connection, Session& Producer, send some messages&
comment|// then close
name|Connection
name|t
init|=
...
literal|null
expr_stmt|;
comment|// Now (re)register the Durable subscriber, setup a listener and wait
comment|// for messages that should
