...
specifier|public
name|void
name|testWireFormatInfoSeverVersion1
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testWireFormatInfoClientVersion1
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testWireFormatInfoCurrentVersion
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testWireFormatInactivityDurationInitialDelay
parameter_list|()
throws|throws
name|Exception
block|{
...
name|startClient
argument_list|(
literal|"tcp://localhost:61616?wireFormat.maxInactivityDurationInitalDelay=60000"
argument_list|)
expr_stmt|;
name|assertTrue
argument_list|(
...
specifier|public
name|void
name|testWireFormatMaxFrameSize
parameter_list|()
throws|throws
name|Exception
block|{
...
name|startClient
argument_list|(
literal|"tcp://localhost:61616?wireFormat.maxFrameSize=1048576"
argument_list|)
expr_stmt|;
name|assertTrue
argument_list|(
