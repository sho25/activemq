...
block|}
block|}
comment|/**      * Return the JMS Properties which where used to send the InputStream      *      * @return jmsProperties      * @throws IOException      */
specifier|public
name|Map
argument_list|<
name|String
