...
begin_comment
comment|/**  * Test that a WS client can steal links when enabled.  */
end_comment

begin_class
specifier|public
class|class
name|MQTTWSLinkStealingTest
extends|extends
...
name|fail
argument_list|(
literal|"Could not open new WS connection for link stealing client"
argument_list|)
expr_stmt|;
block|}
name|theif
...
name|assertTrue
argument_list|(
literal|"Original Connection should close"
argument_list|,
name|Wait
operator|.
name|waitFor
