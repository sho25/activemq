...
specifier|private
name|boolean
name|useAuthenticatedPrincipalForJMXUserID
decl_stmt|;
specifier|private
name|boolean
...
literal|"Type=NetworkConnector,"
operator|+
literal|"NetworkConnectorName=duplex"
operator|+
name|JMXSupport
operator|.
name|encodeObjectNamePart
...
argument_list|(
name|isUseAuthenticatedPrincipalForJMXUserID
argument_list|()
argument_list|)
expr_stmt|;
name|broker
...
specifier|public
name|void
name|setUseAuthenticatedPrincipalForJMXUserID
parameter_list|(
name|boolean
name|useAuthenticatedPrincipalForJMXUserID
parameter_list|)
