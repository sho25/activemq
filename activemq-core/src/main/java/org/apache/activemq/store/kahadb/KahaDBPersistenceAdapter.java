...
expr_stmt|;
block|}
comment|/**      * When true, persist the redelivery status such that the message redelivery flag can survive a broker failure      * used with org.apache.activemq.ActiveMQConnectionFactory#setTransactedIndividualAck(boolean)  true      */
specifier|public
name|void
