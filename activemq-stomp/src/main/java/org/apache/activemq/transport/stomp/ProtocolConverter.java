...
begin_comment
comment|// Global Map shared with all subscriptions to allow finding the sub associated with an ACK Id
end_comment
...
begin_comment
comment|// Read-Only view used in this class to enforce the separation of read vs update of the global index.
end_comment
...
name|warn
argument_list|(
literal|"Exception occurred for client {} ({}) processing: {} -> {} ({})"
argument_list|,
name|connectionInfo
operator|.
name|getClientId
...
name|trace
argument_list|(
literal|"Connection closed with {} pending ACKs still being tracked."
argument_list|,
name|pendingAcks
operator|.
name|size
