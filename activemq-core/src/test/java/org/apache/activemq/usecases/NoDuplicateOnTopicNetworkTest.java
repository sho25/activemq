...
specifier|public
name|boolean
name|suppressDuplicateTopicSubs
init|=
literal|false
decl_stmt|;
specifier|public
...
comment|// when> 1, subscriptions percolate around resulting in duplicates as there is no
...
argument_list|)
expr_stmt|;
comment|// the audit will suppress the duplicates as it defaults to true so this test
comment|// checking for dups will fail. it is good to have it on in practice.
name|policy
operator|.
name|setEnableAudit
argument_list|(
...
specifier|public
name|void
name|initCombosForTestProducerConsumerTopic
parameter_list|()
block|{
name|this
operator|.
...
argument_list|(
literal|"suppressDuplicateTopicSubs"
argument_list|,
operator|new
name|Object
index|[]
...
name|assertTrue
argument_list|(
literal|"consumer started eventually"
argument_list|,
name|consumerStarted
operator|.
name|await
...
argument_list|)
expr_stmt|;
comment|// verify network consumer priority
specifier|final
name|RegionBroker
name|regionBroker
init|=
...
name|assertTrue
argument_list|(
literal|"Found network destination with priority as expected"
argument_list|,
name|Wait
operator|.
name|waitFor
...
argument_list|)
expr_stmt|;
comment|// ensure un-subscription has percolated though the network
name|Thread
operator|.
name|sleep
argument_list|(
