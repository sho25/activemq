...
specifier|private
name|String
name|messageGroupMapFactoryType
init|=
literal|"cached"
decl_stmt|;
specifier|private
...
expr_stmt|;
block|}
comment|/**      * Update a queue with this policy.  Only apply properties that      * match the includedProperties list.  Not all properties are eligible      * to be updated.      *      * If includedProperties is null then all of the properties will be set as      * isUpdate will return true      * @param queue      * @param includedProperties      */
specifier|public
name|void
name|update
parameter_list|(
...
expr_stmt|;
block|}
comment|//If includedProperties is null then all of the properties will be set as
comment|//isUpdate will return true
specifier|public
name|void
name|update
parameter_list|(
...
block|}
block|}
comment|// attributes that can change on the fly
specifier|public
name|void
name|baseUpdate
parameter_list|(
...
argument_list|(
name|getMessageGroupMapFactoryType
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
name|error
argument_list|(
literal|"Failed to create message group Factory "
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
expr_stmt|;
block|}
comment|/**      * Returns true if the original message body should be included when applicable      * for advisory messages      *      * @return      */
specifier|public
name|boolean
name|isIncludeBodyForAdvisory
parameter_list|()
...
return|;
block|}
comment|/**      * Sets if the original message body should be included when applicable      * for advisory messages      *      * @param includeBodyForAdvisory      */
specifier|public
name|void
name|setIncludeBodyForAdvisory
parameter_list|(
