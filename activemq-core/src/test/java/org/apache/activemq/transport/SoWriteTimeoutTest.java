...
argument_list|()
operator|+
literal|"?soWriteTimeout=500)?jms.useAsyncSend=true&trackMessages=true"
argument_list|)
decl_stmt|;
specifier|final
name|Connection
...
name|assertNotNull
argument_list|(
literal|"Got message after reconnect"
argument_list|,
name|consumer
operator|.
name|receive
...
expr_stmt|;
block|}
comment|//broker.getAdminView().get
block|}
specifier|private
name|String
name|initMessagePrefix
