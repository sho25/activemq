...
return|;
block|}
comment|/** 	 * Get the MBeanServer connection. 	 *  	 * @return not<code>null</code> 	 * @throws Exception 	 */
specifier|protected
name|MBeanServerConnection
...
name|brokerName
operator|+
literal|",Type=Connection,ConnectorName="
operator|+
name|connectorName
operator|+
literal|",*"
...
name|brokerName
operator|+
literal|",Type=Connection,*,Connection="
operator|+
name|connectionName
argument_list|)
decl_stmt|;
...
name|brokerName
operator|+
literal|",Type=Connector,ConnectorName="
operator|+
name|name
argument_list|)
decl_stmt|;
...
name|brokerName
operator|+
literal|",Type=Subscription,destinationType=Queue,destinationName="
operator|+
name|queueName
operator|+
literal|",*"
