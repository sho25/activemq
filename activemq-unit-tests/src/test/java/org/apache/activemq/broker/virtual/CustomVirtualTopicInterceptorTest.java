...
begin_comment
comment|/**  * Test for ticket AMQ-6058, shouldDispatch prefix check  */
end_comment

begin_class
specifier|public
class|class
name|CustomVirtualTopicInterceptorTest
extends|extends
name|EmbeddedBrokerTestSupport
block|{
specifier|private
...
name|ActiveMQQueue
argument_list|(
literal|"q.private.vt.testing.test.virtual.topic"
argument_list|)
return|;
block|}
specifier|protected
...
argument_list|)
expr_stmt|;
comment|//check that c2 did not receive the message - this breaks pre-patch,
comment|//when VirtualTopicInterceptor.shouldDispatch always returned true
name|assertNull
argument_list|(
name|c2
operator|.
