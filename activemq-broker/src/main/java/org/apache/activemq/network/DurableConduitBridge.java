...
name|subscription
decl_stmt|;
comment|//check the clientId so we only remove subs for the matching bridge
if|if
condition|(
name|durableSub
operator|.
...
condition|)
block|{
comment|// remove the NC subscription as it is no longer for a permissible dest
name|RemoveSubscriptionInfo
name|sending
init|=
operator|new
...
name|debug
argument_list|(
literal|"Exception removing NC durable subscription: {}"
argument_list|,
name|subName
argument_list|,
name|e
