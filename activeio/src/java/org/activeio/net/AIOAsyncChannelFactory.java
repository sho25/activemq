...
begin_comment
comment|/**  * A TcpAsyncChannelFactory creates {@see org.activeio.net.TcpAsyncChannel}  * and {@see org.activeio.net.TcpAsyncChannelServer} objects.  *   * @version $Revision$  */
end_comment
...
name|DEFAULT_BACKLOG
decl_stmt|;
comment|/**      * Uses the {@param location}'s host and port to create a tcp connection to a remote host.      *       * @see org.activeio.AsyncChannelFactory#openAsyncChannel(java.net.URI)      */
specifier|public
name|AsyncChannel
...
return|;
block|}
comment|/**      * Binds a server socket a the {@param location}'s port.       *       * @see org.activeio.AsyncChannelFactory#bindAsyncChannel(java.net.URI)      */
specifier|public
name|AsyncChannelServer
