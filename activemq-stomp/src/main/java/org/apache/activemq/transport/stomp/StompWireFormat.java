...
name|DEFAULT_CONNECTION_TIMEOUT
decl_stmt|;
comment|//The current frame size as it is unmarshalled from the stream
specifier|private
specifier|final
name|AtomicLong
name|frameSize
...
expr_stmt|;
block|}
comment|// Add a newline to separate the headers from the content.
name|buffer
operator|.
name|append
argument_list|(
...
name|ProtocolException
argument_list|(
literal|"The maximum frame size was exceeded"
argument_list|,
literal|true
argument_list|)
throw|;
