...
specifier|public
name|long
name|clientInactivityLimit
decl_stmt|;
specifier|public
name|long
name|serverInactivityLimit
decl_stmt|;
specifier|protected
name|void
name|setUp
...
name|URI
argument_list|(
literal|"tcp://localhost:61616?trace=true&maxInactivityDuration="
operator|+
name|serverInactivityLimit
argument_list|)
argument_list|)
...
specifier|public
name|void
name|initCombosForTestClientHang
parameter_list|()
block|{
...
specifier|public
name|void
name|initCombosForTestNoClientHang
parameter_list|()
block|{
name|addCombinationValues
argument_list|(
...
expr_stmt|;
block|}
comment|/**      * Used to test when a operation blocks.  This should      * not cause transport to get disconnected.      */
specifier|public
name|void
