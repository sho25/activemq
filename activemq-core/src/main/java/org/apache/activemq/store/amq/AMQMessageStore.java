...
expr_stmt|;
block|}
comment|/*         RecoveryListenerAdapter recoveryListener = new RecoveryListenerAdapter(this, listener);         referenceStore.recoverNextMessages(maxReturned, recoveryListener);         if (recoveryListener.size() == 0&& recoveryListener.hasSpace()) {             flush();             referenceStore.recoverNextMessages(maxReturned, recoveryListener);         }         */
block|}
name|Message
name|getMessage
parameter_list|(
