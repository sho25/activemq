...
name|trace
argument_list|(
literal|"Flow: draining={}, drain={} credit={}, remoteCredit={}, queued={}, unsettled={}"
argument_list|,
name|draining
argument_list|,
name|endpoint
...
name|trace
argument_list|(
literal|"Flow: Pull case -> consumer control with prefetch (0) to control output"
argument_list|)
expr_stmt|;
name|sendToActiveMQ
argument_list|(
...
condition|)
block|{
comment|// ensure prefetch exceeds credit + inflight
if|if
condition|(
name|remoteCredit
operator|+
...
name|trace
argument_list|(
literal|"Adding dispatched size to credit for sub: "
operator|+
name|subscription
argument_list|)
expr_stmt|;
...
name|trace
argument_list|(
literal|"Flow: update -> consumer control with prefetch {}"
argument_list|,
name|control
operator|.
name|getPrefetch
...
name|trace
argument_list|(
literal|"Sender:[{}] updating conumser prefetch:{} after delivery settled."
argument_list|,
name|getEndpoint
argument_list|()
operator|.
