...
return|;
block|}
comment|/**      * Move all the messages that were in the journal into long term storage. We      * just replay and do a checkpoint.      */
specifier|private
name|void
name|recover
parameter_list|()
...
argument_list|)
expr_stmt|;
comment|// rollback any recovered inflight local transactions
name|Set
argument_list|<
name|TransactionId
argument_list|>
...
block|{
comment|// non persistent message case
name|after
operator|.
name|run
argument_list|()
...
block|}
block|}
comment|/**      * Loads a previously stored JournalMessage      */
specifier|public
name|JournalCommand
argument_list|<
name|?
...
return|;
block|}
comment|/**      * do minimal recovery till we reach the last inDoubtLocation      */
name|void
name|process
parameter_list|(
name|JournalCommand
...
block|{
comment|// If the message ID as indexed, then the broker asked us to
comment|// store a DUP
...
block|{
comment|// restore the previous value.. Looks like this was a redo of a
comment|// previously
comment|// added message. We don't want to assign it a new id as the other
...
argument_list|)
expr_stmt|;
comment|// every ack location addition needs to be a btree modification to get it stored
name|sd
operator|.
name|ackPositions
operator|.
...
argument_list|)
expr_stmt|;
comment|// add empty next to keep track of nextMessage
name|sd
operator|.
name|ackPositions
operator|.
...
argument_list|()
decl_stmt|;
comment|// messages that have prepared (pending) acks cannot be redispatched unless the outcome is rollback,
