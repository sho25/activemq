...
expr_stmt|;
block|}
comment|// Add consumer object and message list
name|consumers
operator|.
name|put
argument_list|(
...
name|assertTrue
argument_list|(
literal|"Consumer received less than "
operator|+
name|msgCount
operator|+
...
name|assertTrue
argument_list|(
literal|"Consumer received more than "
operator|+
name|msgCount
operator|+
literal|" messages. Actual messages received is "
...
name|assertTrue
argument_list|(
literal|"Consumer should have received exactly "
operator|+
name|msgCount
operator|+
literal|" messages. Actual messages received is "
...
name|assertTrue
argument_list|(
literal|"Total messages received should have been "
operator|+
name|msgCount
operator|+
literal|". Actual messages received is "
operator|+
name|totalMsg
argument_list|,
operator|(
