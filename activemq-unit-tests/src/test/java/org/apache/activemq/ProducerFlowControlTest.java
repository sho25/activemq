...
name|info
argument_list|(
literal|"received warn log message: "
operator|+
name|event
operator|.
name|getMessage
...
name|info
argument_list|(
literal|"received debug log message: "
operator|+
name|event
operator|.
name|getMessage
...
argument_list|)
expr_stmt|;
comment|// new connection b/c other is blocked
name|connection
operator|=
operator|(
name|ActiveMQConnection
...
name|ActiveMQQueue
argument_list|(
literal|"SomeOtherQueueToPickUpNewPolicy"
argument_list|)
argument_list|)
expr_stmt|;
name|assertEquals
...
control|)
block|{
comment|// force error on blocked connections
name|ActiveMQConnection
name|connection
init|=
operator|(
