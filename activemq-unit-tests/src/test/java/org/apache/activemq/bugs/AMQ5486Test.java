...
argument_list|()
expr_stmt|;
comment|//conn.syncSendPacket(new TransactionInfo(conn.getConnectionInfo().getConnectionId(), null, TransactionInfo.END));
name|connections
operator|.
name|add
argument_list|(
...
name|Exception
block|{
comment|// selector thread will take one thread from the pool
return|return
name|connector
operator|.
name|getConnections
