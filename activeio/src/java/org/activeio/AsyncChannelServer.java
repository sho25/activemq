...
begin_comment
comment|/**  * AsyncChannelServer objects asynchronously accept and create {@see org.activeio.Channel} objects  * and then delivers those objects to a {@see org.activeio.AcceptConsumer}.  *   * @version $Revision$  */
end_comment
