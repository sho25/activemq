...
begin_comment
comment|/**  * SyncChannel objets allow threadd to synchronously block on the<code>receiveUpPacket</code>  * method to get 'up' {@see org.activeio.Packet} objects when they arrive.  *   * @version $Revision$  */
end_comment
