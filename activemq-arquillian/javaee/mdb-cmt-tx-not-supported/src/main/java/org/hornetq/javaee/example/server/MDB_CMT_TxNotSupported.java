...
name|name
operator|=
literal|"MDB_CMT_TxNotSupported"
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// Step 11. lets look at the transaction to make sure there isn't one.
name|Transaction
name|tx
init|=
name|tm
...
name|println
argument_list|(
literal|"tx is null, just as expected"
argument_list|)
expr_stmt|;
block|}
else|else
...
name|println
argument_list|(
literal|"something is wrong, I wasn't expecting a transaction"
argument_list|)
expr_stmt|;
block|}
block|}
