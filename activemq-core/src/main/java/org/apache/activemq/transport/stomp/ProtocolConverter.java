...
specifier|final
name|long
name|DEFAULT_OUTBOUND_HEARTBEAT
init|=
literal|100
decl_stmt|;
specifier|private
...
specifier|final
name|long
name|DEFAULT_INBOUND_HEARTBEAT
init|=
literal|1000
decl_stmt|;
specifier|private
...
specifier|final
name|long
name|DEFAULT_INITIAL_HEARTBEAT_DELAY
init|=
literal|1000
decl_stmt|;
static|static
...
block|{
comment|// TODO: acking with just a message id is very bogus since the same message id
...
name|ProtocolException
argument_list|(
literal|"Invlid heart-beat header:"
operator|+
name|heartBeatConfig
argument_list|,
literal|true
