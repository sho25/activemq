...
specifier|public
name|void
name|testFailoverClientAckMissingRedelivery
parameter_list|()
throws|throws
name|Exception
block|{
...
name|assertTrue
argument_list|(
literal|"add messages are delivered"
argument_list|,
name|Wait
operator|.
name|waitFor
...
begin_comment
comment|// each should again get prefetch messages - all unacked deliveries should be rolledback
end_comment

begin_expr_stmt
name|assertTrue
argument_list|(
literal|"after restart all messages are re dispatched"
argument_list|,
name|Wait
operator|.
name|waitFor
...
name|assertTrue
argument_list|(
literal|"after restart each got prefetch amount"
argument_list|,
name|Wait
operator|.
name|waitFor
