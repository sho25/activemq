...
name|URI
argument_list|(
literal|"broker:(vm://broker1)/broker1?persistent=false&useJmx=false"
argument_list|)
argument_list|)
decl_stmt|;
name|BrokerService
...
name|URI
argument_list|(
literal|"broker:(vm://broker2)/broker2?persistent=false&useJmx=false"
argument_list|)
argument_list|)
decl_stmt|;
...
block|{
comment|// Consume the message and verify that there is no more memory usage.
name|consumerProceed
operator|.
name|release
argument_list|()
...
name|URI
argument_list|(
literal|"broker:(tcp://localhost:0)/broker2?persistent=false&useJmx=false"
argument_list|)
argument_list|)
decl_stmt|;
name|startAllBrokers
