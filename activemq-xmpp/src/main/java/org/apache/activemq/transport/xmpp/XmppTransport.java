...
name|debug
argument_list|(
literal|"Creating new instance of XmppTransport"
argument_list|)
expr_stmt|;
name|converter
operator|=
...
name|warn
argument_list|(
literal|"Not marshalling command as shutting down: "
operator|+
name|command
argument_list|)
expr_stmt|;
...
name|debug
argument_list|(
literal|"Unmarshalled new incoming event - "
operator|+
name|object
operator|.
name|getClass
...
operator|+
literal|"jabber.server.dialback:"
operator|+
...
operator|+
literal|"ietf.params.xml.ns.xmpp_bind:"
operator|+
literal|"ietf.params.xml.ns.xmpp_tls:"
operator|+
literal|"org.jabber.protocol.muc:"
operator|+
literal|"org.jabber.protocol.rosterx:"
operator|+
...
name|debug
argument_list|(
literal|"Sending initial stream element"
argument_list|)
expr_stmt|;
name|XMLOutputFactory
name|factory
...
name|debug
argument_list|(
literal|"Initial stream element sent!"
argument_list|)
expr_stmt|;
block|}
block|}
