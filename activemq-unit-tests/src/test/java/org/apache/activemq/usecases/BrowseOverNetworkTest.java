...
name|assertEquals
argument_list|(
literal|"Consumer on Broker A, should've consumed all messages"
argument_list|,
name|MESSAGE_COUNT
argument_list|,
name|msgsA
...
name|assertEquals
argument_list|(
literal|"Broker B shouldn't get any messages"
argument_list|,
literal|0
argument_list|,
name|browsed
...
name|info
argument_list|(
literal|"Sending messages to broker-1A"
argument_list|)
expr_stmt|;
name|sendMessages
argument_list|(
...
name|info
argument_list|(
literal|"Message sent to broker-1A"
argument_list|)
expr_stmt|;
name|Wait
operator|.
