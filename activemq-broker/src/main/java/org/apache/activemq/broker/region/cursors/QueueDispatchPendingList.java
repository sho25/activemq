...
parameter_list|)
block|{
comment|// for a single consumer inserting at head will be in order w.r.t brokerSequence but
comment|// will not be if there were multiple consumers in the mix even if this is the last
comment|// consumer to close (noConsumers==true)
return|return
operator|!
name|redeliveredWaitingDispatch
operator|.
