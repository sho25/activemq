...
specifier|public
name|void
name|testSubscribeWithWildcardSubscription
parameter_list|()
throws|throws
name|Exception
block|{
...
literal|"SEND\n"
operator|+
literal|"destination:/queue/a.b.c"
operator|+
literal|"\n\n"
operator|+
literal|"Hello World"
...
specifier|public
name|void
name|testDurableSubAndUnSubFlow
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// attempt to remove the durable subscription while there is an active subscription
name|frame
operator|=
literal|"UNSUBSCRIBE\n"
operator|+
...
argument_list|)
expr_stmt|;
comment|// attempt to remove the subscriber leaving the durable sub in place.
name|frame
operator|=
literal|"UNSUBSCRIBE\n"
operator|+
...
argument_list|)
expr_stmt|;
comment|// attempt to remove the durable subscription which should succeed since there are no
comment|// active durable subscribers
name|frame
operator|=
literal|"UNSUBSCRIBE\n"
operator|+
...
specifier|public
name|void
name|testTransactionRollbackAllowsSecondAckOutsideTXClientAck
parameter_list|()
throws|throws
name|Exception
block|{
name|doTestTransactionRollbackAllowsSecondAckOutsideTXClientAck
argument_list|(
literal|"client"
argument_list|)
expr_stmt|;
...
specifier|public
name|void
name|testTransactionRollbackAllowsSecondAckOutsideTXClientIndividualAck
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// ack it in the TX then abort
name|frame
operator|=
literal|"ACK\n"
operator|+
...
argument_list|)
expr_stmt|;
comment|// ack it outside the TX and it should be really ack'd
name|frame
operator|=
literal|"ACK\n"
operator|+
...
specifier|public
name|void
name|testAckMessagesInTransactionOutOfOrderWithTXClientAck
parameter_list|()
throws|throws
name|Exception
block|{
name|doTestAckMessagesInTransactionOutOfOrderWithTXClientAck
argument_list|(
literal|"client"
argument_list|)
expr_stmt|;
...
specifier|public
name|void
name|testAckMessagesInTransactionOutOfOrderWithTXClientIndividualAck
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// ack second, then first message
name|frame
operator|=
literal|"ACK\n"
operator|+
