...
name|warn
argument_list|(
literal|"An existing duplex active connection already exists for this broker ("
operator|+
name|remoteBrokerId
operator|+
literal|"). Stopping it."
