...
begin_comment
comment|/**  * Represents a proxy {@link Connection} which is-a {@link TopicConnection} and  * {@link QueueConnection} which is pooled and on {@link #close()} will return  * itself to the sessionPool.  *   * @version $Revision: 1.1.1.1 $  */
end_comment
...
name|JMSException
block|{
comment|// TODO should we start connections first before pooling them?
name|getConnection
argument_list|()
operator|.
name|start
