...
expr_stmt|;
block|}
comment|/**      * Returns a LogWriter object, given a log writer name (for example "default", or "detailed").      * Uses a ConcurrentHashMap to cache the Class objects that have already been loaded.      * @param logWriterName a log writer name (for example "default", or "detailed").      * @return a LogWriter object to be used by the TransportLogger class.      * @throws IllegalAccessException      * @throws InstantiationException      * @throws IOException      * @throws ClassNotFoundException      */
specifier|public
name|LogWriter
name|newInstance
parameter_list|(
