...
name|warn
argument_list|(
literal|"{} - cursor got duplicate {} seq: {}"
argument_list|,
name|this
argument_list|,
name|message
...
argument_list|)
expr_stmt|;
comment|// a duplicate from the store - needs to be removed/acked - otherwise it will get redispatched on restart
comment|// jdbc store will store duplicates and will set entry locator to sequence long.
comment|// REVISIT - this seems too hacky - see use case AMQ4952Test
if|if
condition|(
operator|!
name|cached
...
name|trace
argument_list|(
literal|"{} - disabling cache. current Id: {} seq: {}, batchList size: {}"
argument_list|,
operator|new
name|Object
index|[]
...
block|{
comment|// store complete - track via lastCachedId
name|setLastCachedId
argument_list|(
name|candidate
argument_list|)
...
argument_list|()
expr_stmt|;
comment|// future should be replaced with sequence by this time
block|}
catch|catch
parameter_list|(
name|CancellationException
