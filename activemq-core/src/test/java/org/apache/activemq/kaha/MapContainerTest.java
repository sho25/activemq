...
specifier|public
name|void
name|testDuplicatesFreeListShared
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// have something on free list before duplicate
name|other
operator|.
name|remove
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// entry now on free list on its own
name|batchEntry
operator|=
name|container
operator|.
...
argument_list|)
expr_stmt|;
comment|//container is valid  (empty)
name|assertNull
argument_list|(
name|container
operator|.
...
argument_list|)
expr_stmt|;
comment|// batchEntry now has next as there is another on the free list
name|batchEntry
operator|=
name|container
operator|.
