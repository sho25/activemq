...
parameter_list|)
function_decl|;
comment|/**      * Event handler for remote peer open of this resource.      *      * @param connection      *        The connection that owns this resource.      *      * @throws IOException if an error occurs while processing the update.      */
name|void
...
name|IOException
function_decl|;
comment|/**      * Event handler for remote peer detach of this resource.      *      * @param connection      *        The connection that owns this resource.      *      * @throws IOException if an error occurs while processing the update.      */
name|void
...
name|IOException
function_decl|;
comment|/**      * Event handler for remote peer close of this resource.      *      * @param connection      *        The connection that owns this resource.      *      * @throws IOException if an error occurs while processing the update.      */
name|void
...
name|IOException
function_decl|;
comment|/**      * Called when the Proton Engine signals an Delivery related event has been triggered      * for the given endpoint.      *      * @param connection      *        The connection that owns this resource.      *      * @throws IOException if an error occurs while processing the update.      */
name|void
...
name|IOException
function_decl|;
comment|/**      * Called when the Proton Engine signals an Flow related event has been triggered      * for the given endpoint.      *      * @param connection      *        The connection that owns this resource.      *      * @throws IOException if an error occurs while processing the update.      */
name|void
...
name|IOException
function_decl|;
comment|/**      * @returns true if the remote end has sent an error      */
name|boolean
name|hasRemoteError
parameter_list|()
function_decl|;
comment|/**      * @return an Exception derived from the error state of the endpoint's Remote Condition.      */
name|Exception
name|getRemoteError
parameter_list|()
function_decl|;
comment|/**      * @return an Error message derived from the error state of the endpoint's Remote Condition.      */
name|String
