...
name|clazz
init|=
literal|"org.apache.activemq.store.kahadb.scheduler.JobSchedulerStoreImpl"
decl_stmt|;
name|jobSchedulerStore
operator|=
operator|(
...
name|RuntimeException
argument_list|(
literal|"Failed to start provided job scheduler store: "
operator|+
name|jobSchedulerStore
argument_list|,
name|e
...
name|objectNameStr
operator|+=
literal|",connector=duplexNetworkConnectors,networkConnectorName="
operator|+
name|JMXSupport
operator|.
name|encodeObjectNamePart
...
name|objectNameStr
operator|+=
literal|",connector=proxyConnectors,proxyConnectorName="
operator|+
name|JMXSupport
operator|.
name|encodeObjectNamePart
...
name|objectNameStr
operator|+=
literal|",connector=jmsConnectors,JmsConnectors="
operator|+
name|JMXSupport
operator|.
name|encodeObjectNamePart
