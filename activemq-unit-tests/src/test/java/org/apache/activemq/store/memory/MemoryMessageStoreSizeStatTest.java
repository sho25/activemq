...
argument_list|)
decl_stmt|;
comment|//verify the count and size, should be 100 because of the LRUCache
comment|//verify size is at least the minimum of 100 messages times 100 bytes
name|verifyStats
argument_list|(
name|dest
argument_list|,
...
argument_list|)
expr_stmt|;
comment|//Since an LRU cache is used and messages are kept in memory, this should be 100 still
name|verifyStats
argument_list|(
name|dest
argument_list|,
...
expr_stmt|;
comment|//The expected value is only 100 because for durables a LRUCache is being used
comment|//with a max size of 100, so only 100 messages are kept
name|Destination
name|dest
init|=
name|publishTestMessagesDurable
...
argument_list|)
expr_stmt|;
comment|//Should be 100 messages still
name|verifyStats
argument_list|(
name|dest
argument_list|,
