...
condition|)
block|{
comment|// we missed the pending dispatch during start
if|if
condition|(
name|peer
operator|.
...
throw|;
block|}
comment|// ensure there is no missed dispatch during start, sync with oneway
synchronized|synchronized
init|(
name|peer
operator|.
...
name|IOException
argument_list|(
literal|"reconnection Not supported by this transport."
argument_list|)
throw|;
block|}
specifier|public
