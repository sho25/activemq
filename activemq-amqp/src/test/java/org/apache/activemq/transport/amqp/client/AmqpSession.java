...
return|;
block|}
comment|/**      * Create a sender instance using the given Target      *      * @param target      *        the caller created and configured Traget used to create the sender link.      *      * @return a newly created sender that is ready for use.      *      * @throws Exception if an error occurs while creating the receiver.      */
specifier|public
name|AmqpSender
name|createSender
parameter_list|(
