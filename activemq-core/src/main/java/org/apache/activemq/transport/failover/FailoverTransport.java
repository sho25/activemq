...
condition|)
block|{
comment|//don't want errors from old transport
name|old
operator|.
...
block|}
block|}
comment|// Avoid double firing a transportInterupted() event due to an extra IOException
if|if
condition|(
name|transportListener
operator|!=
