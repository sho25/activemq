...
argument_list|)
decl_stmt|;
comment|//Look up an existing entry that matches the candidate
...
condition|)
block|{
comment|//if found, update the policy and apply the updates to existing destinations
name|updatedEntry
operator|=
name|fromDto
argument_list|(
...
name|info
argument_list|(
literal|"cannot find policy entry candidate to update: "
operator|+
name|updatedEntry
operator|+
literal|", destination:"
