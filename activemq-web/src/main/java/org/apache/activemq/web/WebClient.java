...
specifier|final
name|String
name|USERNAME_INIT_PARAM
init|=
literal|"org.apache.activemq.username"
decl_stmt|;
specifier|public
specifier|static
specifier|final
name|String
name|PASSWORD_INIT_PARAM
init|=
literal|"org.apache.activemq.password"
decl_stmt|;
specifier|public
specifier|static
specifier|final
...
name|BROKER_URL_INIT_PARAM
operator|+
literal|" param, trying to find a broker embedded in a local VM"
argument_list|)
expr_stmt|;
name|BrokerService
name|broker
...
name|BROKER_URL_INIT_PARAM
operator|+
literal|" init-Param) or embedded broker"
argument_list|)
throw|;
block|}
else|else
