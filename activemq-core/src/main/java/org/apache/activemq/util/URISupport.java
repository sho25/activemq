...
argument_list|(
literal|"Invalid position for first parenthesis: "
operator|+
name|first
argument_list|)
throw|;
...
name|IllegalArgumentException
argument_list|(
literal|"character at indicated position is not a parenthesis"
argument_list|)
throw|;
block|}
name|int
...
name|str
argument_list|,
literal|"URI did not contain a matching parenthesis."
argument_list|)
throw|;
block|}
return|return
