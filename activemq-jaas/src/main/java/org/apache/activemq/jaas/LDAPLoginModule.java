...
specifier|final
name|String
name|EXPAND_ROLES_MATCHING
init|=
literal|"expandRolesMatching"
decl_stmt|;
specifier|private
specifier|static
name|Logger
...
name|debug
argument_list|(
literal|"LDAP returned a relative name: {}"
argument_list|,
name|result
operator|.
name|getName
...
name|debug
argument_list|(
literal|"LDAP returned an absolute name: {}"
argument_list|,
name|result
operator|.
name|getName
...
name|FailedLoginException
argument_list|(
literal|"Error parsing absolute name as URI."
argument_list|)
decl_stmt|;
name|ex
operator|.
...
block|{
name|MessageFormat
name|expandRolesMatchingFormat
init|=
operator|new
name|MessageFormat
argument_list|(
