...
name|QueueReceiver
block|{
comment|/**      * @param theSession      * @param consumerId      * @param destination      * @param selector      * @param prefetch      * @param maximumPendingMessageCount      * @param asyncDispatch      *      * @throws JMSException      */
specifier|protected
name|ActiveMQQueueReceiver
parameter_list|(
