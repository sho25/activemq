...
argument_list|()
decl_stmt|;
comment|// messages might not all be delivered during the 1st poll. We need to
comment|// check again.
specifier|final
name|StringBuffer
name|buf2
...
name|port
argument_list|,
literal|"destination=queue://testA&type=listen&message=handlerA&clientId=clientA"
argument_list|)
decl_stmt|;
...
name|port
argument_list|,
literal|"destination=queue://testB&type=listen&message=handlerB&clientId=clientB"
argument_list|,
literal|null
argument_list|,
name|sessionId
