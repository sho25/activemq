...
begin_comment
comment|/**      * Remove all pending acknowledgement markers that are batched into the single      * client acknowledge operation.      *      * @param subscription      *      The STOMP Subscription that has performed a client acknowledge.      * @param msgIdsToRemove      *      List of message IDs that are bound to the subscription that has ack'd      */
end_comment
...
name|trace
argument_list|(
literal|"Subscription:[{}] client acknowledged {} messages"
argument_list|,
name|subscription
operator|.
