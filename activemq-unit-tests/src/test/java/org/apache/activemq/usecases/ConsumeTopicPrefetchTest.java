...
expr_stmt|;
block|}
comment|// delayed delivered ack a .5 prefetch
name|validateConsumerPrefetchGreaterOrEqual
argument_list|(
name|this
operator|.
name|getSubject
...
expr_stmt|;
block|}
comment|// second batch to consume the rest
for|for
control|(
name|int
name|i
...
name|JMSException
block|{
name|doValidateConsumerPrefetch
argument_list|(
name|subject
argument_list|,
name|min
