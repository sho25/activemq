...
decl_stmt|;
comment|//to avoid calling into sendToActiveMq from a handler
specifier|private
name|ScheduledThreadPoolExecutor
name|scheduledThreadPoolExecutor
init|=
...
comment|// by autogenerating the bytecode to statically lookup a handler from a
comment|// registry maybe?
name|Handler
name|handler
init|=
name|registry
...
argument_list|)
expr_stmt|;
comment|// create a destination for this client
specifier|final
name|String
name|to
init|=
...
name|debug
argument_list|(
literal|"Unable to create destination for "
operator|+
name|to
argument_list|)
expr_stmt|;
...
comment|// lets create a subscription for the room, Jabber clients would use
comment|// "room/nickname", so we need to strip off the nickname
name|String
name|to
init|=
name|presence
