...
expr_stmt|;
block|}
comment|//should through exception IllegalStateException:The session is closed
annotation|@
name|Test
argument_list|(
name|timeout
...
specifier|public
name|void
name|testBrokerRestartPersistentQueueException
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testProducerThrowsWhenBrokerRestarted
parameter_list|()
throws|throws
name|Exception
block|{
...
name|info
argument_list|(
literal|"Message JMSExpiration = {} JMSTimeStamp = {} TTL = {}"
argument_list|,
operator|new
name|Object
index|[]
