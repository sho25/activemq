...
argument_list|)
expr_stmt|;
comment|// Step 11. lets look at the user transaction to make sure there isn't one.
name|UserTransaction
name|tx
init|=
name|ctx
...
name|println
argument_list|(
literal|"we're in the middle of a transaction: "
operator|+
name|tx
argument_list|)
expr_stmt|;
...
name|println
argument_list|(
literal|"something is wrong, I was expecting a transaction"
argument_list|)
expr_stmt|;
block|}
block|}
