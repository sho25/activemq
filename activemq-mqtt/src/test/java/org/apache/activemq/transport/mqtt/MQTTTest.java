...
try|try
block|{
comment|// copy the buffers before we decode
name|Buffer
index|[]
name|buffers
init|=
...
argument_list|)
expr_stmt|;
comment|// reset frame buffers to deep copy
name|frame
operator|.
name|buffers
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// make sure we received distinct ids for QoS != AT_MOST_ONCE, and 0 for AT_MOST_ONCE
for|for
control|(
name|int
name|i
...
argument_list|)
expr_stmt|;
comment|// drop subs without acknowledging messages, then subscribe and receive again
name|connection
operator|.
name|unsubscribe
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// wait for all acks to be processed
name|Thread
operator|.
name|sleep
argument_list|(
...
condition|)
block|{
comment|// one of them is a duplicate
name|assertTrue
argument_list|(
name|publishList
operator|.
