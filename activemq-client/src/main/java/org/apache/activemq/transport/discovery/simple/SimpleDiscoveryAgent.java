...
name|debug
argument_list|(
literal|"Failure occurred soon after the discovery event was generated.  It will be classified as a connection failure: {}"
argument_list|,
name|event
argument_list|)
expr_stmt|;
...
name|warn
argument_list|(
literal|"Reconnect attempts exceeded {} tries.  Reconnecting has been disabled for: {}"
argument_list|,
name|maxReconnectAttempts
argument_list|,
name|event
...
name|trace
argument_list|(
literal|"Failure occurred to long after the discovery event was generated.  "
operator|+
literal|"It will not be classified as a connection failure: {}"
argument_list|,
name|event
argument_list|)
expr_stmt|;
...
block|}
argument_list|,
literal|"Simple Discovery Agent"
argument_list|)
expr_stmt|;
block|}
block|}
...
name|debug
argument_list|(
literal|"Waiting {}ms before attempting to reconnect."
argument_list|,
name|event
operator|.
name|reconnectDelay
