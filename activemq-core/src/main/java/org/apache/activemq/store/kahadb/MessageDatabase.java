...
name|info
argument_list|(
literal|"Size of sd.messageIdIndex = "
operator|+
name|messageIdCount
argument_list|)
expr_stmt|;
...
name|info
argument_list|(
literal|"Size of sd.locationIndex = "
operator|+
name|locationCount
argument_list|)
expr_stmt|;
...
name|info
argument_list|(
literal|"Size of sd.ackPositions = "
operator|+
name|sd
operator|.
name|ackPositions
...
name|info
argument_list|(
literal|"Size of sd.messageReferences = "
operator|+
name|sd
operator|.
...
name|append
argument_list|(
literal|"sd.messageIdIndex contains ["
argument_list|)
expr_stmt|;
for|for
control|(
...
name|append
argument_list|(
literal|"sd.locationIndex contains ["
argument_list|)
expr_stmt|;
for|for
control|(
...
name|info
argument_list|(
literal|"Order index last default key: "
operator|+
name|sd
operator|.
name|orderIndex
...
name|info
argument_list|(
literal|"Order index last high key: "
operator|+
name|sd
operator|.
name|orderIndex
...
name|info
argument_list|(
literal|"Order index last low key: "
operator|+
name|sd
operator|.
name|orderIndex
