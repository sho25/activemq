...
block|}
block|}
comment|/**      * Used to recover the message list non durable subscriptions.  Recovery only happens if the consumer is      * retroactive.      *       * @param context      * @param sub      * @throws Throwable      */
specifier|private
name|void
name|recover
parameter_list|(
...
block|}
block|}
comment|/**      * Used to recover the message list for a durable subscription.      *       * @param context      * @param sub      * @param initialActivation      * @throws Throwable      */
specifier|public
name|void
name|recover
parameter_list|(
...
condition|)
block|{
comment|// Then use the subscriptionRecoveryPolicy since there will not be any messages in the persistent store.
if|if
condition|(
name|persistenceWasOptimized
condition|)
