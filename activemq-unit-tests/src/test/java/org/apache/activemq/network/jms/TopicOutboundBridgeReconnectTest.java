...
name|assertTrue
argument_list|(
literal|"Should have a bridge to the topic"
argument_list|,
name|Wait
operator|.
name|waitFor
...
argument_list|(
literal|"Producer broker is not running."
argument_list|)
throw|;
block|}
name|ObjectName
...
name|IllegalStateException
argument_list|(
literal|"Consumer broker is not running."
argument_list|)
throw|;
block|}
name|ObjectName
