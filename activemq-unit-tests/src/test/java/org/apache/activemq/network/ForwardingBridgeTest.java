...
specifier|public
name|void
name|initCombosForTestForwardMessageCompressed
parameter_list|()
block|{
...
specifier|public
name|void
name|testForwardMessageCompressed
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// Give forwarding bridge a chance to finish setting up
try|try
block|{
name|Thread
operator|.
...
argument_list|)
expr_stmt|;
comment|// Make sure its compressed now
name|ActiveMQMessage
name|message
init|=
operator|(
