...
name|TRANSPORT_URI
init|=
literal|"tcp://localhost:0?transport.useKeepAlive=false&wireFormat.maxInactivityDuration=10000"
decl_stmt|;
specifier|private
name|String
name|url
...
name|url
operator|+
literal|"?useKeepAlive=false&wireFormat.maxInactivityDuration=10000)"
argument_list|)
decl_stmt|;
end_decl_stmt
