...
specifier|public
class|class
name|CachedLDAPAuthorizationModuleOpenLDAPTest
extends|extends
...
argument_list|,
literal|"org/apache/activemq/security/activemq-openldap.ldif"
argument_list|,
name|LDAP_HOST
argument_list|,
name|LDAP_PORT
...
argument_list|(
literal|"org/apache/activemq/security/activemq-openldap-add.ldif"
argument_list|)
return|;
block|}
annotation|@
...
name|getResourceAsStream
argument_list|(
literal|"org/apache/activemq/security/activemq-openldap-delete.ldif"
argument_list|)
return|;
block|}
annotation|@
...
block|{
return|return
literal|"cn=users,ou=Group,ou=ActiveMQ,dc=activemq,dc=apache,dc=org"
return|;
block|}
annotation|@
name|Override
