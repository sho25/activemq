...
expr_stmt|;
block|}
comment|/**      * Test that an amqp-value body containing a map that has an AMQP Binary as one of the      * entries encoded into the Map results in an MapMessage where a byte array can be read      * from the entry.      *      * @throws Exception if an error occurs during the test.      */
annotation|@
name|Test
specifier|public
name|void
name|testCreateAmqpMapMessageFromAmqpValueWithMapContainingBinaryEntry
parameter_list|()
throws|throws
name|Exception
block|{
