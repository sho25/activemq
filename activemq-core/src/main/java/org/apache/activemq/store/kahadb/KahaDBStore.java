...
block|}
block|}
comment|// an ack for an unmatched message is stored as a negative sequence id
comment|// if sub has been getting unmatched acks, we need to reset
specifier|protected
name|Long
name|resetForSelectors
parameter_list|(
name|SubscriptionInfo
name|info
parameter_list|,
