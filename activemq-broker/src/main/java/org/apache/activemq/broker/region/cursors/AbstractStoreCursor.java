...
condition|)
block|{
comment|// only async adds, lets wait on the potential last add and reset from there
for|for
control|(
name|ListIterator
argument_list|<
...
block|{
comment|// mix of async and sync - async can exceed sync only if next in sequence
for|for
control|(
name|Iterator
argument_list|<
