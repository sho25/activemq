...
block|{
comment|// if there are already paged messages
comment|// dispatch them
if|if
condition|(
name|pagedInMessages
operator|.
...
name|error
argument_list|(
literal|"Failed to dispatch already paged messages "
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
name|Exception
block|{
comment|//QueueMessageReference node = (QueueMessageReference) m;
name|boolean
name|result
init|=
literal|true
