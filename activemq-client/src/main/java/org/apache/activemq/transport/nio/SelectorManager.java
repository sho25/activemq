...
specifier|final
name|int
name|workQueueCapicity
init|=
name|getDefaultWorkQueueCapacity
argument_list|()
decl_stmt|;
return|return
name|workQueueCapicity
...
specifier|static
name|int
name|getDefaultMaxChannelsPerWorker
parameter_list|()
block|{
return|return
name|Integer
...
name|getInteger
argument_list|(
literal|"org.apache.activemq.transport.nio.SelectorManager.maxChannelsPerWorker"
argument_list|,
literal|1024
argument_list|)
return|;
