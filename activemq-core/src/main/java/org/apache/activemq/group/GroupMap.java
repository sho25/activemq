...
begin_comment
comment|/**  *<P>  * A<CODE>GroupMap</CODE> is a Map implementation that is used to shared state   * amongst a distributed group of other<CODE>GroupMap</CODE> instances.   * Membership of a group is handled automatically using discovery.  *<P>  * The underlying transport is JMS and there are some optimizations that occur  * for membership if used with ActiveMQ - but<CODE>GroupMap</CODE> can be used  * with any JMS implementation.  *   *<P>  * Updates to the group shared map are controlled by a coordinator. The  * coordinator is elected by the member with the lowest lexicographical id -   * based on the bully algorithm [Silberschatz et al. 1993]  *<P>  * The {@link #selectCordinator(Collection<Member> members)} method may be  * overridden to implement a custom mechanism for choosing  how the coordinator  * is elected for the map.  *<P>  * New<CODE>GroupMap</CODE> instances have their state updated by the coordinator,  * and coordinator failure is handled automatically within the group.  *<P>  * All updates are totally ordered through the coordinator, whilst read operations   * happen locally.   *<P>  * A<CODE>GroupMap</CODE>supports the concept of owner only updates(write locks),   * shared updates, entry expiration times and removal on owner exit -   * all of which are optional.  *   *<P>  *   * @param<K> the key type  * @param<V> the value type  *   */
end_comment
...
return|;
block|}
comment|/**      * Puts an value into the map associated with the key      *       * @param key      * @param value      * @return the old value or null      * @throws GroupMapUpdateException      * @throws IllegalStateException      *       */
specifier|public
name|V
name|put
parameter_list|(
...
return|;
block|}
comment|/**      * Puts an value into the map associated with the key      *       * @param key      * @param value      * @param sharedWrites      * @param removeOnExit      * @param timeToLive      * @return the old value or null      * @throws GroupMapUpdateException      * @throws IllegalStateException      *       */
specifier|public
name|V
name|put
parameter_list|(
...
return|;
block|}
comment|/**      * Add the Map to the distribution      *       * @param t      * @throws GroupMapUpdateException      * @throws IllegalStateException      */
specifier|public
name|void
name|putAll
parameter_list|(
...
expr_stmt|;
block|}
comment|/**      * Add the Map to the distribution      *       * @param t      * @param sharedWrites      * @param removeOnExit      * @param timeToLive      * @throws GroupMapUpdateException      * @throws IllegalStateException      */
specifier|public
name|void
name|putAll
parameter_list|(
...
block|}
block|}
comment|/**      * remove a value from the map associated with the key      *       * @param key      * @return the Value or null      * @throws GroupMapUpdateException      * @throws IllegalStateException      *       */
specifier|public
name|V
name|remove
parameter_list|(
