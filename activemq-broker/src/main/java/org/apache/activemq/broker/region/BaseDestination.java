...
name|trace
argument_list|(
literal|"processing duplicate in {}, prepared {} "
argument_list|,
name|transactionId
argument_list|,
name|preparedTx
...
condition|)
block|{
comment|// duplicates from past transactions expected after org.apache.activemq.broker.region.Destination#clearPendingMessages
comment|// till they are acked
name|getLog
argument_list|()
operator|.
name|debug
argument_list|(
literal|"duplicate message from store {}, from historical transaction {}, ignoring"
argument_list|,
name|message
operator|.
name|getMessageId
...
name|debug
argument_list|(
literal|"failed to determine state of transaction {} on duplicate message {}"
argument_list|,
name|transactionId
argument_list|,
name|message
