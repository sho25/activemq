...
name|Exception
block|{
comment|// Test mutual authentication on both stomp and standard ssl transports
name|bindAddress
operator|=
literal|"stomp+ssl://localhost:61612"
expr_stmt|;
name|confUri
operator|=
literal|"xbean:org/apache/activemq/transport/stomp/sslstomp-mutual-auth-broker.xml"
expr_stmt|;
name|jmsUri
operator|=
