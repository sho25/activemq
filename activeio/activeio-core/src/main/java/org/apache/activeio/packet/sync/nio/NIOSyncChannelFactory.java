...
begin_comment
comment|/**  * A TcpSynchChannelFactory creates {@see org.apache.activeio.net.TcpSynchChannel}  * and {@see org.apache.activeio.net.TcpSynchChannelServer} objects.  *   * @version $Revision$  */
end_comment
...
expr_stmt|;
block|}
comment|/**      * Uses the {@param location}'s host and port to create a tcp connection to a remote host.      *       * @see org.apache.activeio.SynchChannelFactory#openSyncChannel(java.net.URI)      */
specifier|public
name|SyncChannel
...
return|;
block|}
comment|/**      * Binds a server socket a the {@param location}'s port.       *       * @see org.apache.activeio.SynchChannelFactory#bindSynchChannel(java.net.URI)      */
specifier|public
name|SyncChannelServer
