...
begin_comment
comment|/**  * Adapts a {@see org.apache.activeio,SynchChannelServer} so that it provides an   * {@see org.apache.activeio.AsyncChannelServer} interface.  When this channel  * is started, a background thread is used to poll the (@see org.apache.activeio.SynchChannelServer}  * for accepted channel connections which are then delivered to the {@see org.apache.activeio.AcceptConsumer}.  *   * @version $Revision$  */
end_comment
...
block|}
block|}
comment|/**      * @see org.apache.activeio.packet.async.AsyncChannelServer#setAcceptListener(org.apache.activeio.AcceptListener)      */
specifier|public
name|void
