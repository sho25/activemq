...
name|info
argument_list|(
literal|"Using default discovery uri "
operator|+
name|uri
argument_list|)
expr_stmt|;
...
block|{
comment|// only set the discovery URI if a non-default multicast IP/port endpoint is being used.
name|log
operator|.
name|info
argument_list|(
literal|"Setting discovery uri to "
operator|+
name|uri
argument_list|)
expr_stmt|;
