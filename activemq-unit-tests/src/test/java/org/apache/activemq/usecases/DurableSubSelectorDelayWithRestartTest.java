...
specifier|public
class|class
name|DurableSubSelectorDelayWithRestartTest
block|{
specifier|private
specifier|static
specifier|final
...
argument_list|()
expr_stmt|;
comment|//for the last subscriber pop one message into the topic.
name|subscribers
index|[
operator|(
name|subscribers
...
argument_list|()
expr_stmt|;
comment|// unsubscribe all, but the last subscriber.
for|for
control|(
name|int
name|j
...
name|url
init|=
literal|"failover:(tcp://localhost:61656)"
decl_stmt|;
specifier|final
name|ConnectionFactory
name|cf
...
argument_list|()
expr_stmt|;
comment|//restart broker all the time
if|if
condition|(
name|RESTART
condition|)
