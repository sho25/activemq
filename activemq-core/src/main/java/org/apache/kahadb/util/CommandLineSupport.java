...
begin_comment
comment|/**  * Support utility that can be used to set the properties on any object  * using command line arguments.  *   * @author<a href="http://hiramchirino.com">Hiram Chirino</a>  */
end_comment
