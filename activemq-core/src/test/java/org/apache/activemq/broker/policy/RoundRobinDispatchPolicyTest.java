...
comment|// We cannot guarantee that messages will be equally divided, since
comment|// prefetch is one
...
argument_list|()
expr_stmt|;
comment|// Since there are more consumers, each consumer should have received at
comment|// most one message only
name|assertMessagesDividedAmongConsumers
argument_list|()
expr_stmt|;
block|}
...
specifier|public
name|void
name|testOneProducerTwoMatchingConsumersOneNotMatchingConsumer
parameter_list|()
throws|throws
name|Exception
block|{
comment|// Create consumer that won't consume any message
