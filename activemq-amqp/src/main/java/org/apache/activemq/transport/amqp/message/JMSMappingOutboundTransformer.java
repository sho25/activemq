...
return|;
block|}
comment|/**      * Perform the conversion between JMS Message and Proton Message without      * re-encoding it to array. This is needed because some frameworks may elect      * to do this on their own way.      *      * @param message      *      The message to transform into an AMQP version for dispatch.      *      * @return an AMQP Message that represents the given JMS Message.      *      * @throws Exception if an error occurs during the conversion.      */
specifier|public
name|ProtonJMessage
name|convert
parameter_list|(
