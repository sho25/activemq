...
specifier|public
name|void
name|testMapMessageUsingPrimitiveSettersSendReceive
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// Now consume the MapMessage
name|Message
name|received
init|=
name|amqpConsumer
...
name|assertTrue
argument_list|(
literal|"Expected MapMessage but got "
operator|+
name|received
argument_list|,
name|received
...
argument_list|)
expr_stmt|;
comment|// Test for the byte array which will be in an AMQP Binary as this message
comment|// is received as an ObjectMessage by Qpid JMS
name|Object
name|incomingValue
init|=
name|incomingMap
...
specifier|public
name|void
name|testMapInObjectMessageSendReceive
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// Now consume the ObjectMessage
name|Message
name|received
init|=
name|amqpConsumer
...
expr_stmt|;
block|}
comment|//----- Test Qpid JMS to Qpid JMS interop with transformers --------------//
annotation|@
name|Test
specifier|public
name|void
name|testQpidJMSToQpidJMSMessageSendReceive
parameter_list|()
throws|throws
name|Exception
block|{
...
name|assertTrue
argument_list|(
literal|"Expected BytesMessage but got "
operator|+
name|received
argument_list|,
name|received
