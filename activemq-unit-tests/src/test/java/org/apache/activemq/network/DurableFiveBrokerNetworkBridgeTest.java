...
specifier|public
name|void
name|testDurablePropagationBrokerRestartDuplex
parameter_list|()
throws|throws
name|Exception
block|{
...
literal|true
expr_stmt|;
name|testDurablePropagationBrokerRestart
argument_list|()
expr_stmt|;
block|}
specifier|public
name|void
name|testDurablePropagationBrokerRestartOneWay
parameter_list|()
throws|throws
name|Exception
block|{
...
name|String
argument_list|(
literal|"?persistent=true&useJmx=false"
argument_list|)
decl_stmt|;
name|createBroker
argument_list|(
...
name|URI
argument_list|(
literal|"broker:(tcp://localhost:61616)/Broker_A_A"
operator|+
name|options
argument_list|)
argument_list|)
...
name|URI
argument_list|(
literal|"broker:(tcp://localhost:61617)/Broker_B_B"
operator|+
name|options
argument_list|)
argument_list|)
...
name|URI
argument_list|(
literal|"broker:(tcp://localhost:61618)/Broker_C_C"
operator|+
name|options
argument_list|)
argument_list|)
...
name|URI
argument_list|(
literal|"broker:(tcp://localhost:61619)/Broker_D_D"
operator|+
name|options
argument_list|)
argument_list|)
...
name|URI
argument_list|(
literal|"broker:(tcp://localhost:61620)/Broker_E_E"
operator|+
name|options
argument_list|)
argument_list|)
...
argument_list|)
expr_stmt|;
comment|//bring one online and leave others offline to test mixed
name|clientE
operator|=
name|ses2
operator|.
...
expr_stmt|;
block|}
comment|/**      * Broker_A_A -> Broker_B_B -> Broker_C_C      */
specifier|protected
name|void
name|testDurablePropagation
parameter_list|()
...
name|separator
operator|+
literal|"DurableFiveBrokerNetworkBridgeTest"
argument_list|)
expr_stmt|;
block|}
specifier|protected
