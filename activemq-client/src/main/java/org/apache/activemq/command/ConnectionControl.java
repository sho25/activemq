...
begin_comment
comment|/**  * Used to start and stop transports as well as terminating clients.  *   * @openwire:marshaller code="18"  *   */
end_comment
...
expr_stmt|;
block|}
comment|/**      * @openwire:property version=6 cache=false      * @return connected brokers.      */
specifier|public
name|String
...
return|;
block|}
comment|/**      * @param connectedBrokers the connectedBrokers to set      */
specifier|public
name|void
...
expr_stmt|;
block|}
comment|/**      *  @openwire:property version=6 cache=false      * @return the reconnectTo      */
specifier|public
name|String
name|getReconnectTo
parameter_list|()
...
return|;
block|}
comment|/**      * @param reconnectTo the reconnectTo to set      */
specifier|public
name|void
name|setReconnectTo
parameter_list|(
...
expr_stmt|;
block|}
comment|/**      * @return the rebalanceConnection      *  @openwire:property version=6 cache=false      */
specifier|public
name|boolean
...
return|;
block|}
comment|/**      * @param rebalanceConnection the rebalanceConnection to set      */
specifier|public
name|void
...
expr_stmt|;
block|}
comment|/**      * @openwire:property version=8      * @return the token      */
specifier|public
name|byte
index|[]
name|getToken
