...
begin_comment
comment|/**  * A {@see org.apache.activeio.SynchChannel} implementation that uses a {@see java.net.Socket}  *  to talk to the network.  *   * @version $Revision$  */
end_comment
...
expr_stmt|;
block|}
comment|/**      * @see org.apache.activeio.SynchChannel#read(long)      */
