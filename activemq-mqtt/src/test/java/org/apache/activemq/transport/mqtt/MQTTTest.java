...
name|assertTrue
argument_list|(
literal|"MQTT Connection should be registered."
argument_list|,
name|Wait
operator|.
name|waitFor
...
argument_list|)
expr_stmt|;
comment|// wait for broker to time out the MQTT connection due to inactivity
name|assertTrue
argument_list|(
literal|"MQTT Connection should be timed out."
argument_list|,
name|Wait
operator|.
name|waitFor
