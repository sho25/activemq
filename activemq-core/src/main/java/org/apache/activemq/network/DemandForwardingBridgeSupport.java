...
if|if
condition|(
name|isDuplicateNetworkSubscription
argument_list|(
name|info
argument_list|)
condition|)
...
return|;
block|}
comment|/*      * check our existing subs networkConsumerIds against the list of network ids in this subscription      * a match means a duplicate which we suppress for topics      */
specifier|private
name|boolean
name|isDuplicateNetworkSubscription
parameter_list|(
...
name|currentSubs
init|=
name|getTopicRegionSubscriptions
argument_list|()
decl_stmt|;
for|for
control|(
...
name|consumerInfo
operator|+
literal|" is duplicated by network subscription: "
operator|+
name|sub
operator|.
name|getConsumerInfo
