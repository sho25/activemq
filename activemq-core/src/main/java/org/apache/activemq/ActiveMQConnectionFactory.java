...
name|setProperty
argument_list|(
literal|"onSendPrepareMessageBody"
argument_list|,
name|Boolean
operator|.
name|toString
...
expr_stmt|;
block|}
comment|/**      * Retrieve a Reference for this instance to store in JNDI      *      * @return the built Reference      * @throws NamingException if error on building Reference      */
specifier|public
name|Reference
name|getReference
parameter_list|()
