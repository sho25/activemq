...
argument_list|(
literal|"Transport Options cannot be null"
argument_list|)
throw|;
block|}
if|if
...
name|IllegalArgumentException
argument_list|(
literal|"Transport remote location cannot be null"
argument_list|)
throw|;
block|}
name|this
...
parameter_list|)
block|{
comment|// TODO: can we stop it throwing Exception?
throw|throw
name|IOExceptionSupport
operator|.
name|create
...
name|trace
argument_list|(
literal|"Channel group shutdown failed to complete in allotted time"
argument_list|)
expr_stmt|;
block|}
name|group
...
name|IllegalStateException
argument_list|(
literal|"Cannot change Max Frame Size while connected."
argument_list|)
throw|;
block|}
name|this
...
return|;
block|}
comment|//----- Event Handlers which can be overridden in subclasses -------------//
specifier|protected
name|void
...
expr_stmt|;
block|}
comment|/*      * Called when the transport connection failed and an error should be returned.      */
specifier|private
name|void
name|connectionFailed
parameter_list|(
...
name|Exception
block|{
comment|// In the Secure case we need to let the handshake complete before we
comment|// trigger the connected event.
if|if
condition|(
operator|!
name|isSSL
...
block|}
block|}
comment|//----- Handle Binary data from connection -------------------------------//
specifier|protected
class|class
name|NettyTcpTransportHandler
extends|extends
