...
argument_list|()
decl_stmt|;
comment|// roll up all message sends
class|class
name|SendSync
extends|extends
name|Synchronization
...
block|}
class|class
name|OrderedNonTransactionWorkTx
extends|extends
name|Transaction
block|{
annotation|@
...
name|error
argument_list|(
literal|"Failed to add not transactional message to orderedWork"
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
block|}
block|}
comment|// called while holding the sendLock
specifier|private
name|void
name|registerSendSync
parameter_list|(
name|Message
name|message
parameter_list|,
...
decl_stmt|;
name|boolean
name|needsOrderingWithTransactions
init|=
name|context
operator|.
name|isInTransaction
