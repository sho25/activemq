...
specifier|public
class|class
name|AutoNIOSslTransportBrokerTest
extends|extends
name|TransportBrokerTestSupport
block|{
specifier|public
...
block|{
return|return
literal|"auto+nio+ssl://localhost:0?transport.soWriteTimeout=20000"
return|;
block|}
annotation|@
name|Override
...
name|URI
argument_list|(
literal|"auto+nio+ssl://localhost:0?soWriteTimeout=20000"
argument_list|)
return|;
block|}
annotation|@
