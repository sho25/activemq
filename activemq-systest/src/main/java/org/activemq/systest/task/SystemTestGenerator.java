...
name|println
argument_list|(
literal|" *<a href='http://activemq.org'>ActiveMQ: The Open Source Message Fabric</a> "
argument_list|)
expr_stmt|;
name|writer
operator|.
...
name|println
argument_list|(
literal|" * Copyright 2005 LogicBlaze, Inc."
argument_list|)
expr_stmt|;
name|writer
operator|.
...
name|println
argument_list|(
literal|"import org.activemq.systest.DestinationFactory;"
argument_list|)
expr_stmt|;
name|writer
operator|.
name|println
argument_list|(
literal|"import org.activemq.systest.ScenarioTestSuite;"
argument_list|)
expr_stmt|;
name|writer
operator|.
