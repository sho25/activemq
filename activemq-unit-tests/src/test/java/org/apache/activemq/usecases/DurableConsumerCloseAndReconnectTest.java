...
specifier|public
name|void
name|testDurableSubscriberReconnectMultipleTimes
parameter_list|()
throws|throws
name|Exception
block|{
...
name|Exception
block|{
comment|// default to client ack for consumer
name|makeConsumer
argument_list|()
expr_stmt|;
name|closeConsumer
...
name|info
argument_list|(
literal|"Creating a durable subscriber for clientID: "
operator|+
name|clientID
operator|+
