...
expr_stmt|;
block|}
comment|/**      * Uses the {@param location}'s host and port to create a tcp connection to a remote host.      *       * @see org.apache.activeio.SyncChannelFactory#openSyncChannel(java.net.URI)      */
specifier|public
name|SyncChannel
...
return|;
block|}
comment|/**      * Binds a server socket a the {@param bindURI}'s port.      *       * @see org.apache.activeio.SyncChannelFactory#bindSyncChannel(java.net.URI)      */
specifier|public
name|SyncChannelServer
