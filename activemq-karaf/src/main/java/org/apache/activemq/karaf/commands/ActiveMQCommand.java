...
argument_list|()
decl_stmt|;
comment|// short circut convert via blueprint... cause all our commands match this
comment|// bluepring was failing to convert the last long param to a string for browse
comment|// where dest is a numeric value - activemq-karaf-itests
comment|// see: org.apache.activemq.karaf.itest.ActiveMQBrokerFeatureTest.test()
if|if
condition|(
name|val
operator|instanceof
