...
operator|++
expr_stmt|;
comment|// allow outstanding messages to get delivered again
...
block|}
block|}
comment|// async (on next call) clear delivered as they will be auto-acked as duplicates if they arrive again
specifier|private
name|void
name|clearDispatchList
parameter_list|()
...
argument_list|()
operator|+
literal|" tracking delivered list ("
operator|+
name|deliveredMessages
operator|.
name|size
