...
name|File
argument_list|(
literal|"target/test-amq-5393/datadb"
argument_list|)
decl_stmt|;
name|File
name|testfile
...
name|File
argument_list|(
literal|"target/test-amq-5393/testfile"
argument_list|)
decl_stmt|;
specifier|private
name|BrokerService
...
comment|//the broker should adjust the usage limit..set time to 5 seconds for testing
...
argument_list|()
decl_stmt|;
comment|//write a 1 meg file to the file system
name|writeTestFile
argument_list|(
literal|1024
operator|*
...
name|assertTrue
argument_list|(
literal|"Temp Usage should ramp down."
argument_list|,
name|Wait
operator|.
name|waitFor
...
argument_list|)
expr_stmt|;
comment|//Assert that the usage limits have not changed because writing a 1 meg file
