...
specifier|public
name|void
name|testExpiredMessages_onTopic_withPrefetchExtension
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// We don't check the DLQ because non-persistent messages on topics are discarded instead.
specifier|final
name|List
argument_list|<
name|Subscription
...
specifier|public
name|void
name|testExpiredMessages_onTopic_withoutPrefetchExtension
parameter_list|()
throws|throws
name|Exception
block|{
...
name|assertTrue
argument_list|(
literal|"prefetch extension was incremented"
argument_list|,
name|subscriptions
operator|.
name|stream
