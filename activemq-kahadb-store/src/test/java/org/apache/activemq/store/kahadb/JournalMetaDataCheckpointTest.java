...
specifier|public
class|class
name|JournalMetaDataCheckpointTest
block|{
specifier|private
specifier|static
specifier|final
...
specifier|public
name|void
name|testRecoveryOnDeleteFailureMetaDataOk
parameter_list|()
throws|throws
name|Exception
block|{
...
name|info
argument_list|(
literal|"Sent {}, Num journal files: {} "
argument_list|,
name|sent
argument_list|,
name|numFilesAfterSend
...
argument_list|)
expr_stmt|;
comment|// verify metadata is correct on disk
specifier|final
name|MessageDatabase
operator|.
name|Metadata
index|[]
name|fromDiskMetaData
init|=
operator|new
name|MessageDatabase
operator|.
...
argument_list|()
decl_stmt|;
comment|// need to avoid cache and in-progress writes of existing pageFile
name|PageFile
name|fromDiskPageFile
init|=
operator|new
name|PageFile
argument_list|(
...
specifier|public
name|void
name|testAckMessageFileMapSyncOnModOnly
parameter_list|()
throws|throws
name|Exception
block|{
...
name|assertEquals
argument_list|(
literal|"location is not changed on no modification"
argument_list|,
name|ackMessageFileModLoc
argument_list|,
name|messageStore
