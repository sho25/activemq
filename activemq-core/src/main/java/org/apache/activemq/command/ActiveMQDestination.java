...
literal|null
expr_stmt|;
comment|// If this is a pattern destination.
if|if
condition|(
operator|!
name|isTemporary
...
name|setProperty
argument_list|(
literal|"destinationTypeAsString"
argument_list|,
name|getDestinationTypeAsString
argument_list|()
argument_list|)
...
return|;
block|}
comment|/**      * Retrieve a Reference for this instance to store in JNDI      *      * @return the built Reference      * @throws javax.naming.NamingException if error on building Reference      */
specifier|public
name|Reference
name|getReference
parameter_list|()
