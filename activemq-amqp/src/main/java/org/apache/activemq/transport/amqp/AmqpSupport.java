...
block|}
block|}
comment|/**      * Given an ActiveMQDestination return the proper Capability value for the concrete destination type.      *      * @param destination      *      The ActiveMQDestination whose capability is being requested.      *      * @return a Symbol that matches the defined Capability value for the ActiveMQDestiantion.      */
specifier|public
specifier|static
name|Symbol
name|getDestinationTypeSymbol
parameter_list|(
name|ActiveMQDestination
name|destination
parameter_list|)
