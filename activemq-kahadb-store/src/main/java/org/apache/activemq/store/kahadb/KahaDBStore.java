...
comment|// wait for add completion to remove potential pending addition
name|message
operator|.
name|getMessageId
argument_list|()
...
name|warn
argument_list|(
literal|"{} unexpected exception tracking completion of async add of {}"
argument_list|,
name|this
argument_list|,
name|message
...
comment|// of messages in the destination.
name|StoredDestination
name|sd
init|=
name|getStoredDestination
...
expr_stmt|;
comment|// Hopefully one day the page file supports concurrent read
comment|// operations... but for now we must externally synchronize...
name|indexLock
operator|.
name|writeLock
argument_list|()
...
name|warn
argument_list|(
literal|"{} Location {} not found in order index for {}"
argument_list|,
name|this
argument_list|,
name|identity
