...
begin_comment
comment|/**  * Makes all the channels produced by another [@see org.apache.activeio.SyncChannelFactory}  * have write operations that have built in delays for testing.   *   * @version $Revision$  */
end_comment
