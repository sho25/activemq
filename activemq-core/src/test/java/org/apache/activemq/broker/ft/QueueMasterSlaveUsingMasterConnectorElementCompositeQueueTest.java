...
begin_comment
comment|/**  * Let's test composite destinations  *   */
end_comment

begin_class
specifier|public
class|class
name|QueueMasterSlaveUsingMasterConnectorElementCompositeQueueTest
extends|extends
name|QueueMasterSlaveUsingMasterConnectorElementTest
block|{
...
block|{
return|return
literal|"queue://FOO.BAR.HUMBUG,queue://FOO.BAR.HUMBUG2"
return|;
block|}
block|}
end_class
