...
begin_comment
comment|/**  * Optimized ByteArrayOutputStream  *   * @version $Revision$  */
end_comment
...
expr_stmt|;
block|}
comment|/**      * start using a fresh byte array      */
specifier|public
name|void
name|restart
parameter_list|()
...
expr_stmt|;
block|}
comment|/**      * Set the current position for writing      *       * @param offset      * @throws IOException       */
specifier|public
name|void
name|position
parameter_list|(
...
block|}
block|}
comment|/**      * This method is called after each write to the buffer.  This should allow subclasses       * to take some action based on the writes, for example flushing data to an external system based on size.       */
specifier|protected
name|void
name|onWrite
parameter_list|()
