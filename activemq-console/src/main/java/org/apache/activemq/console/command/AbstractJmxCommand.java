...
init|=
literal|"com.sun.management.jmxremote.localConnectorAddress"
decl_stmt|;
specifier|private
name|JMXServiceURL
name|jmxServiceUrl
...
return|;
block|}
comment|/**      * Finds the JMX Url for a VM by its process id      *      * @param pid      * 		The process id value of the VM to search for.      *      * @return the JMX Url of the VM with the given pid or null if not found.      */
annotation|@
...
comment|// tools.jar are not always included used by default class loader, so we
comment|// will try to use custom loader that will try to load tools.jar
name|String
name|javaHome
init|=
name|System
...
name|forName
argument_list|(
literal|"com.sun.tools.attach.VirtualMachine"
argument_list|,
literal|true
argument_list|,
name|loader
...
name|forName
argument_list|(
literal|"com.sun.tools.attach.VirtualMachineDescriptor"
argument_list|,
literal|true
argument_list|,
name|loader
...
name|print
argument_list|(
literal|"useJmxServiceUrl Found JMS Url: "
operator|+
name|jmxUrl
argument_list|)
expr_stmt|;
