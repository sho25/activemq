...
comment|// set their limits based on ours.
for|for
control|(
name|T
name|child
...
return|;
block|}
comment|// Must be called with the usage lock's writeLock held.
specifier|private
name|void
name|fireEvent
parameter_list|(
...
name|info
argument_list|(
literal|"Usage({}) limit={} should be smaller than its parent limit={}"
argument_list|,
operator|new
name|Object
index|[]
