...
specifier|public
name|void
name|testStartWithDatabaseDown
parameter_list|()
throws|throws
name|Exception
block|{
...
name|fail
argument_list|(
literal|"Broker should have been stopped!"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|startsWith
argument_list|(
literal|"IOExceptionHandler"
argument_list|)
condition|)
block|{
name|fail
argument_list|(
literal|"IOExceptionHanlder still active"
argument_list|)
expr_stmt|;
block|}
block|}
...
name|fail
argument_list|(
literal|"JMX Server Connector should have been stopped!"
argument_list|)
expr_stmt|;
block|}
block|}
...
block|}
block|}
comment|/*      * Wrapped the derby datasource object to get DB reconnect functionality as I not      * manage to get that working directly on the EmbeddedDataSource      *      */
specifier|public
class|class
name|ReconnectingEmbeddedDataSource
