...
comment|//PolicyEntry policyEntry = new PolicyEntry();
comment|//policyEntry.setMaxBrowsePageSize(10000);
comment|//pMap.put(new ActiveMQQueue(">"), policyEntry);
comment|// when no policy match, browserSub has maxMessages==0
