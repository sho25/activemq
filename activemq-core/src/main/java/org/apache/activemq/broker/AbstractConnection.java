...
argument_list|()
decl_stmt|;
comment|// If the message originates from this client connection,
comment|// then, finde the associated producer state so we can do some dup detection.
name|ProducerState
name|producerState
init|=
literal|null
...
name|IllegalStateException
argument_list|(
literal|"Cannot send from a session that had not been registered: "
operator|+
name|producerId
operator|.
name|getParentId
...
block|{
comment|// We are a concurrent connection... it must be client reconnect.
name|localConnectionStates
operator|.
name|put
argument_list|(
