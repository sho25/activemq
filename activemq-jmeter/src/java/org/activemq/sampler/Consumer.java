...
begin_comment
comment|//import org.mr.MantaAgent;
end_comment
...
condition|)
block|{
comment|//                    consumer = ((TopicSession) session).createDurableSubscriber(topic,
comment|//                                   s.getInstance().getAgentName());
block|}
else|else
block|{
name|consumer
