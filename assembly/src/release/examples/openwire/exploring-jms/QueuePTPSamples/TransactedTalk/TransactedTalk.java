...
argument_list|)
expr_stmt|;
comment|// We want to be able up commit/rollback messages sent,
comment|// but not affect messages received.  Therefore, we need two sessions.
name|sendSession
operator|=
name|connect
operator|.
...
argument_list|)
expr_stmt|;
comment|// Now that 'receive' setup is complete, start the Connection
name|connect
operator|.
name|start
argument_list|()
...
name|println
argument_list|(
literal|"TransactedTalk application:"
argument_list|)
expr_stmt|;
name|System
operator|.
...
name|println
argument_list|(
literal|"The application will stage messages to "
operator|+
name|sQueue
operator|+
literal|" until you either commit them or roll them back."
argument_list|)
expr_stmt|;
name|System
operator|.
...
name|println
argument_list|(
literal|"The application receives messages on "
operator|+
name|rQueue
operator|+
literal|" to consume any committed messages sent there.\n"
argument_list|)
expr_stmt|;
name|System
operator|.
...
name|println
argument_list|(
literal|"1. Enter text to send and then press Enter to stage the message."
argument_list|)
expr_stmt|;
name|System
operator|.
...
name|println
argument_list|(
literal|"     o Enter the text 'COMMIT', and press Enter to send all the staged messages."
argument_list|)
expr_stmt|;
name|System
operator|.
...
argument_list|)
expr_stmt|;
comment|// Queues usually are used for PERSISTENT messages.
comment|// Hold messages for 30 minutes (1,800,000 millisecs).
name|sender
operator|.
name|send
argument_list|(
...
name|append
argument_list|(
literal|"usage: java TransactedTalk (options) ...\n\n"
argument_list|)
expr_stmt|;
name|use
operator|.
