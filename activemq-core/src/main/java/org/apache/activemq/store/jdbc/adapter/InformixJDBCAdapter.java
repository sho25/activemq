...
begin_comment
comment|/**  * JDBC Adapter for Informix database.  * Because Informix database restricts length of composite primary keys, length of   *<i>container name</i> field and<i>subscription id</i> field must be reduced to 150 characters.  * Therefore be sure not to use longer names for container name and subscription id than 150 characters.  *    * @org.apache.xbean.XBean element="informixJDBCAdapter"  */
end_comment
