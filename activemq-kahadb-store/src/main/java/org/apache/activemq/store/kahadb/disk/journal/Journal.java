...
argument_list|()
decl_stmt|;
comment|// tackle corruption when checksum is disabled or corrupt with zeros, minimise data loss
specifier|public
name|void
...
name|info
argument_list|(
literal|"Using journal preallocation scope of batch allocation"
argument_list|)
expr_stmt|;
block|}
block|}
...
name|error
argument_list|(
literal|"Could not preallocate journal file with sparse file! Will continue without preallocation"
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
argument_list|)
decl_stmt|;
comment|// intentional double initialization due to interaction with the OS level
comment|// file allocation mechanics.
for|for
control|(
name|int
name|i
