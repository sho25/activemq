...
specifier|public
name|void
name|testConsumerOnEachBrokerNetworkQueueConduitSubs
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
comment|//Conduit network queue conduit subs is true so should only be 2 subs
name|assertExactConsumersConnect
argument_list|(
literal|"Broker0"
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// still should be 3 subs for the middle broker, 1 for each direction
name|assertExactConsumersConnect
argument_list|(
literal|"Broker1"
argument_list|,
