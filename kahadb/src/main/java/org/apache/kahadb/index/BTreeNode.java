...
argument_list|()
operator|:
literal|"Should have linked to the next leaf node."
assert|;
name|nextIndex
operator|=
literal|0
...
block|}
block|}
comment|/**      * Returns the right most leaf from the current btree graph.      * @throws IOException      */
specifier|private
name|BTreeNode
argument_list|<
name|Key
...
return|;
block|}
comment|/**      * Returns the left most leaf from the current btree graph.      * @throws IOException      */
specifier|private
name|BTreeNode
argument_list|<
name|Key
...
comment|// and relink the previous leaf to skip to the next leaf.
name|BTreeNode
argument_list|<
name|Key
argument_list|,
...
condition|)
block|{
comment|// easy if we this node hold the previous child.
name|previousLeaf
operator|=
name|getChild
argument_list|(
...
block|{
comment|// less easy if we need to go to the parent to find the previous child.
name|BTreeNode
argument_list|<
name|Key
argument_list|,
...
expr_stmt|;
block|}
comment|// lp will be null if there was no previous child.
block|}
if|if
condition|(
name|previousLeaf
