...
argument_list|)
expr_stmt|;
comment|//Step 15. We lookup the reply queue
name|queue
operator|=
operator|(
name|Queue
...
name|lookup
argument_list|(
literal|"jms/queues/replyQueue"
argument_list|)
expr_stmt|;
comment|//Step 16. We create a JMS message consumer
name|MessageConsumer
name|messageConsumer
init|=
name|session
...
argument_list|)
decl_stmt|;
comment|//Step 17. We start the connedction so we can receive messages
name|connection
operator|.
name|start
argument_list|()
expr_stmt|;
comment|//Step 18. We receive the message and print it out
name|message
operator|=
operator|(
name|TextMessage
