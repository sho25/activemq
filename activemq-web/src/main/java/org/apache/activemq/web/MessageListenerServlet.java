...
argument_list|)
decl_stmt|;
comment|// System.err.println("POST client="+client+"
comment|// session="+request.getSession().getId()+"
comment|// info="+request.getPathInfo()+" query="+request.getQueryString());
name|String
name|text
init|=
...
argument_list|)
expr_stmt|;
comment|// System.err.println("Sent "+message+" to "+destination);
comment|/*              * StringWriter swriter = new StringWriter(); PrintWriter writer =              * new PrintWriter(swriter);              *               * writer.println("<ajax-response><response type='object'              * id='amqSend'><amq jmsid='"+message.getJMSMessageID()+"'/></response></ajax-response>");              * writer.flush(); String m=swriter.toString();              * System.err.println(m); response.getWriter().write(m);              * response.getWriter().flush();              */
block|}
catch|catch
parameter_list|(
name|JMSException
...
argument_list|)
decl_stmt|;
comment|// System.err.println("GET client="+client+"
comment|// session="+request.getSession().getId()+"
comment|// info="+request.getPathInfo()+" query="+request.getQueryString());
name|Destination
name|destination
...
name|println
argument_list|(
literal|"<response type='object' id='amqPoll'><ok/></response>"
argument_list|)
expr_stmt|;
name|writer
operator|.
