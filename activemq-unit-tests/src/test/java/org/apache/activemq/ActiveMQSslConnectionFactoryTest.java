...
specifier|public
name|void
name|testCreateFailoverTcpConnectionUsingKnownPort
parameter_list|()
throws|throws
name|Exception
block|{
...
name|ActiveMQSslConnectionFactory
argument_list|(
literal|"failover:(tcp://localhost:61610?wireFormat.tcpNoDelayEnabled=true)"
argument_list|)
decl_stmt|;
name|connection
operator|=
...
specifier|public
name|void
name|testFailoverSslConnection
parameter_list|()
throws|throws
name|Exception
block|{
...
name|sslUri
operator|+
literal|")?maxReconnectAttempts=4"
argument_list|)
decl_stmt|;
name|cf
operator|.
...
specifier|public
name|void
name|testFailoverSslConnectionWithKeyAndTrustManagers
parameter_list|()
throws|throws
name|Exception
block|{
