...
return|;
block|}
comment|/**      * Create a sender instance using the given address      *      * @param address      *        the address to which the sender will produce its messages.      * @param desiredCapabilities      *        the capabilities that the caller wants the remote to support.      *      * @return a newly created sender that is ready for use.      *      * @throws Exception if an error occurs while creating the sender.      */
specifier|public
name|AmqpSender
name|createSender
parameter_list|(
...
return|;
block|}
comment|/**      * Create a sender instance using the given address      *      * @param address      *        the address to which the sender will produce its messages.      * @param senderSettlementMode      *        controls the settlement mode used by the created Sender      * @param receiverSettlementMode      *        controls the desired settlement mode used by the remote Receiver      *      * @return a newly created sender that is ready for use.      *      * @throws Exception if an error occurs while creating the sender.      */
specifier|public
name|AmqpSender
name|createSender
parameter_list|(
...
return|;
block|}
comment|/**      * Create a sender instance using the given address      *      * @param address      * 	      the address to which the sender will produce its messages.      * @param presettle      *        controls if the created sender produces message that have already been marked settled.      * @param desiredCapabilities      *        the capabilities that the caller wants the remote to support.      * @param offeredCapabilities      *        the capabilities that the caller wants the advertise support for.      * @param properties      *        the properties to send as part of the sender open.      *      * @return a newly created sender that is ready for use.      *      * @throws Exception if an error occurs while creating the sender.      */
specifier|public
name|AmqpSender
name|createSender
parameter_list|(
...
return|;
block|}
comment|/**      * Create a sender instance using the given Target      *      * @param target      *        the caller created and configured Target used to create the sender link.      *      * @return a newly created sender that is ready for use.      *      * @throws Exception if an error occurs while creating the receiver.      */
specifier|public
name|AmqpSender
name|createSender
parameter_list|(
...
return|;
block|}
comment|/**      * Create a sender instance using the given Target      *      * @param target      *        the caller created and configured Target used to create the sender link.      * @param sender      *        the sender ID to assign to the newly created Sender.      *      * @return a newly created sender that is ready for use.      *      * @throws Exception if an error occurs while creating the receiver.      */
specifier|public
name|AmqpSender
name|createSender
parameter_list|(
...
return|;
block|}
comment|/**      * Create a sender instance using the given Target      *      * @param target      *        the caller created and configured Target used to create the sender link.      * @param sender      *        the sender ID to assign to the newly created Sender.      * @param desiredCapabilities      *        the capabilities that the caller wants the remote to support.      * @param offeredCapabilities      *        the capabilities that the caller wants the advertise support for.      * @param properties      *        the properties to send as part of the sender open.      *      * @return a newly created sender that is ready for use.      *      * @throws Exception if an error occurs while creating the receiver.      */
specifier|public
name|AmqpSender
name|createSender
parameter_list|(
...
return|;
block|}
comment|/**      * Create a receiver instance using the given address      *      * @param address      *        the address to which the receiver will subscribe for its messages.      * @param selector      *        the JMS selector to use for the subscription      * @param noLocal      *        should the subscription have messages from its connection filtered.      * @param presettle      *        should the receiver be created with a settled sender mode.      *      * @return a newly created receiver that is ready for use.      *      * @throws Exception if an error occurs while creating the receiver.      */
specifier|public
name|AmqpReceiver
name|createReceiver
parameter_list|(
...
return|;
block|}
comment|/**      * Create a receiver instance using the given address      *      * @param address      *        the address to which the receiver will subscribe for its messages.      * @param senderSettlementMode      *        controls the desired settlement mode used by the remote Sender      * @param receiverSettlementMode      *        controls the settlement mode used by the created Receiver      *      * @return a newly created receiver that is ready for use.      *      * @throws Exception if an error occurs while creating the receiver.      */
specifier|public
name|AmqpReceiver
name|createReceiver
parameter_list|(
...
return|;
block|}
comment|/**      * Create a receiver instance using the given Source      *      * @param source      *        the caller created and configured Source used to create the receiver link.      *      * @return a newly created receiver that is ready for use.      *      * @throws Exception if an error occurs while creating the receiver.      */
specifier|public
name|AmqpReceiver
name|createReceiver
parameter_list|(
...
return|;
block|}
comment|/**      * Create a receiver instance using the given Source      *      * @param source      *        the caller created and configured Source used to create the receiver link.      * @param receivedId      *        the ID value to assign to the newly created receiver      *      * @return a newly created receiver that is ready for use.      *      * @throws Exception if an error occurs while creating the receiver.      */
specifier|public
name|AmqpReceiver
name|createReceiver
parameter_list|(
...
return|;
block|}
comment|/**      * Create a receiver instance using the given address that creates a durable subscription.      *      * @param subscriptionName      *        the name of the subscription that should be queried for on the remote..      *      * @return a newly created receiver that is ready for use if the subscription exists.      *      * @throws Exception if an error occurs while creating the receiver.      */
specifier|public
name|AmqpReceiver
