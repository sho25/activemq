...
name|ObjectName
argument_list|(
literal|"Test:BrokerName=BrokerNC,Type=Topic,Destination=ActiveMQ.Advisory.NetworkBridge"
argument_list|)
argument_list|)
argument_list|)
argument_list|)
...
name|ObjectName
argument_list|(
literal|"Test:BrokerName=BrokerNC,Type=jobScheduler,jobSchedulerName=JMS"
argument_list|)
argument_list|)
argument_list|)
argument_list|)
